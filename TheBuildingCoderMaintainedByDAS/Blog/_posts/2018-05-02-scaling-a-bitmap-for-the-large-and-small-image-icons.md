---
layout: "post"
title: "Scaling a Bitmap for the Large and Small Image Icons"
...
categories:
  ...
  - "Utilities"
  - "Win32"
original_url: "https://thebuildingcoder.typepad.com/blog/2018/05/scaling-a-bitmap-for-the-large-and-small-image-icons.html "
typepad_basename: "scaling-a-bitmap-for-the-large-and-small-image-icons"
typepad_status: "Publish"
---

<p>Every time I created a ribbon button, I was faced with the task of creating appropriately scaled icons for it to populate the <code>PushButton</code> large and small image icon properties <code>LargeImage</code> and <code>Image</code>.</p>

<p>They seem to expect a 32 x 32 and 16 x 16 icon, respectively.</p>

<p>I finally solved that once and for all by implementing a couple of methods to perform automatic bitmap scaling:</p>

<ul>
<li><a href="#3">BitmapImageToBitmap</a> &ndash; convert a <code>BitmapImage</code> to <code>Bitmap</code></li>
<li><a href="#4">BitmapToBitmapSource</a> &ndash; convert a <code>Bitmap</code> to a <code>BitmapSource</code></li>
<li><a href="#5">ResizeImage</a> &ndash; resize an image to the specified width and height</li>
<li><a href="#6">ScaledIcon</a> &ndash; return a scaled down icon of desired size for Revit ribbon button</li>
<li><a href="#7">Usage sample</a> &ndash; putting them together</li>
</ul>

<p>Here they are one by one:</p>

<h4><a name="3"></a>BitmapImageToBitmap</h4>
...
<h4><a name="4"></a>BitmapToBitmapSource</h4>
...
<h4><a name="6"></a>ScaledIcon</h4>

<p><code>ScaledIcon</code> simply calls the three helper methods defined above to return a scaled version of the input image:</p>
...
<h4><a name="7"></a>Usage Sample</h4>

<p>Within the external application <code>PopulatePanel</code> method, simply read the embedded resource icon image and apply <code>ScaledIcon</code> to it to populate the large and small image properties with appropriately scaled images:</p>
...
<p><a class="asset-img-link"  href="http://thebuildingcoder.typepad.com/.a/6a00e553e1689788330224e0368d5f200d-popup" onclick="window.open( this.href, '_blank', 'width=640,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0' ); return false"><img class="asset  asset-image at-xid-6a00e553e1689788330224e0368d5f200d img-responsive" style="width: 220px; display: block; margin-left: auto; margin-right: auto;" alt="Embedded icon resources" title="Embedded icon resources" src="/assets/image_473ff4.jpg" /></a><br /></p>
