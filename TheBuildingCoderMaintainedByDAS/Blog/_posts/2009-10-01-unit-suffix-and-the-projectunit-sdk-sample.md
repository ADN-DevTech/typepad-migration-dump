...
categories:
  ...
  - "Units"
  - "User Interface"
original_url: "https://thebuildingcoder.typepad.com/blog/2009/10/unit-suffix-and-the-projectunit-sdk-sample.html "
typepad_basename: "unit-suffix-and-the-projectunit-sdk-sample"
...
<p class="asset asset-image"><a style="display: inline;" href="http://thebuildingcoder.typepad.com/.a/6a00e553e1689788330120a6052011970c-popup" onclick="window.open( this.href, '_blank', 'width=640,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0' ); return false"><img class="at-xid-6a00e553e1689788330120a6052011970c image-full" alt="Revit SDK sample ProjectUnit" title="Revit SDK sample ProjectUnit" src="/assets/image_d58c98.jpg" border="0"  /></a>
</p>
