...
date: "2010-05-03 05:00:00"
author: "Jeremy Tammik"
categories:
  - "2011"
  - "Element Creation"
  - "Migration"
original_url: "https://thebuildingcoder.typepad.com/blog/2010/05/detail-curve-must-be-in-plane.html "
typepad_basename: "detail-curve-must-be-in-plane"
...
<ul>
<li><a href="http://thebuildingcoder.typepad.com/blog/2008/12/2d-polygon-areas-and-outer-

loop.html">2D polygons</a>
...
<p>Here is another example of a curve input argument that must reside in a specific 
...
<p>I would suggest that you split the algorithm into two parts and implement 

separate independent methods for each of them:
...
<p>In the case of the line, the tessellation only returns two points. I once heard that that is the only element that does that, all non-linear curves return at least three. So you could use this property to determine that the curve is a line (and add an assertion as well, if you like).
