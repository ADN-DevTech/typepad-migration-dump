---
layout: "post"
title: "Determining Views Showing an Element"
date: "2016-12-07 05:00:00"
...
categories:
  ...
  - "Photo"
  - "View"
original_url: "https://thebuildingcoder.typepad.com/blog/2016/12/determining-views-showing-an-element.html "
typepad_basename: "determining-views-showing-an-element"
...
<p><a class="asset-img-link"  style="display: inline;" href="http://thebuildingcoder.typepad.com/.a/6a00e553e16897883301b7c8b9c5ef970b-popup" onclick="window.open( this.href, '_blank', 'width=640,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0' ); return false"><img class="asset  asset-image at-xid-6a00e553e16897883301b7c8b9c5ef970b image-full img-responsive" alt="Early morning on the way to the Munich Forge accelerator" title="Early morning on the way to the Munich Forge accelerator" src="/assets/image_4f795d.jpg" border="0" /></a><br /></p>
...
<ul>
<li>Given any particular element (by extension, perhaps a set of elements):
<ul>
...
<li><a href="https://github.com/jeremytammik/the_building_coder_samples">The Building Coder samples GitHub repository</a>
<ul>
