...
categories:
  ...
  - "Ribbon"
  - "User Interface"
original_url: "https://thebuildingcoder.typepad.com/blog/2009/12/custom-ribbon-tab.html "
typepad_basename: "custom-ribbon-tab"
...
<a style="display: inline;" href="http://thebuildingcoder.typepad.com/.a/6a00e553e1689788330120a758e496970b-popup" onclick="window.open( this.href, '_blank', 'width=640,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0' ); return false"><img class="asset  asset-image at-xid-6a00e553e1689788330120a758e496970b image-full" alt="Custom ribbon tab" title="Custom ribbon tab" src="/assets/image_901799.jpg" border="0"  /></a> <br />

</center>

<p>Here is the complete 

<span class="asset  asset-generic at-xid-6a00e553e1689788330128765be30f970c"><a href="http://thebuildingcoder.typepad.com/files/addribbontab.zip">AddRibbonTab</a></span> source code and Visual Studio solution.</p>
