...
categories:
  ...
  - "Units"
  - "Utilities"
original_url: "https://thebuildingcoder.typepad.com/blog/2017/08/unit-abbreviations.html "
typepad_basename: "unit-abbreviations"
...
Here are both 
the <a href="http://thebuildingcoder.typepad.com/files/hd_rvt_unittypes.zip">complete Visual Studio Revit add-in project <code>RVT_UnitTypes.zip</code></a> and
the <a href="http://thebuildingcoder.typepad.com/files/hd_unitabbrevhandler.cs">C# module <code>UnitAbbrevHandler.cs</code></a></span> it generates.</p>
...
<p><a class="asset-img-link"  style="display: inline;" href="http://thebuildingcoder.typepad.com/.a/6a00e553e16897883301bb09ba17ce970d-popup" onclick="window.open( this.href, '_blank', 'width=640,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0' ); return false"><img class="asset  asset-image at-xid-6a00e553e16897883301bb09ba17ce970d img-responsive" style="width: 300px; " alt="SI base units" title="SI base units" src="/assets/image_d671fa.jpg" /></a><br /></p>
