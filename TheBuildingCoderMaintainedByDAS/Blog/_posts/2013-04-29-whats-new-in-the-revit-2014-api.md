...
categories:
  ...
  - "SDK Samples"
  - "Update"
original_url: "https://thebuildingcoder.typepad.com/blog/2013/04/whats-new-in-the-revit-2014-api.html "
typepad_basename: "whats-new-in-the-revit-2014-api"
typepad_status: "Publish"
---

<p>Here is one post that I prepared well for in advance, by publishing the previous 'What's New in the API' sections two months back:</p>
<ul>
...
<p>The reason for copying it here on-line as well is to ensure that the valuable information provided is picked up by web searches.
More and more people, myself included, perform a web search straight away, first thing, before even looking at the API documentation.</p>
<p>For more detailed information on the pointers provided below, please refer to the complete API documentation and developer's guide.</p>

<p>For a short summary of the main highlights, please refer to the
...
which also points to the complete materials from the Revit 2014 DevDays presentations:</p>
...
<p>This document consists of three main sections:</p>
<ul>
...
<p>I hope this proves useful to you and you find the new API features as useful and exciting as I do!</p>
<a name="1"></a>
<h1>Major Changes and Renovations</h1>
<h2>Document APIs</h2>
<h3>Document.Save()</h3>
...
<ul>
<li>UnitUtils.Convert() &ndash; Converts a value from one unit type to another, such as square feet to square meters.</li>
<li>UnitUtils.ConvertFromInternalUnits() &ndash; Converts a value from Revit's internal unit type.</li>
<li>UnitUtils.ConvertToInternalUnits() &ndash; Converts a value to Revit's internal unit type.</li>
</ul>
...
<p>AppearanceAssetElements can be found via element filtering &ndash; they expose the following members:</p>
<ul>
<li>AppearanceAssetElement.Create() &ndash; creates a new asset element for a given rendering Asset and name.</li>
<li>AppearanceAssetElement.GetAppearanceAssetElementByName() &ndash; gets an asset element handle given the name.</li>
<li>AppearanceAssetElement.SetRenderingAsset() &ndash; Sets the rendering Asset to the element</li>
</ul>
...
<ul>
<li>AssetPropertyList &ndash; a property consisting of a list of AssetProperty members. </li>
<li>AssetPropertyFloatArray &ndash; a property consisting of an array of float values.</li>
<li>AssetPropertyUInt64 &ndash; a property of UInt64 value.</li>
<li>AssetPropertyInt64 &ndash; a property of Int64 value.</li>
</ul>
<p>Some of the return values of AssetProperty.GetTypeName() have been changed as shown here listing input argument, old return and new return:</p>
<ul>
<li>APT_Double &ndash; "Double1" &ndash; "Double"
<li>APT_DoubleArray2d &ndash; "Double2" &ndash; "DoubleArray2d"
<li>APT_DoubleArray3d &ndash; "Double3" &ndash; "DoubleArray3d"
<li>APT_DoubleArray4d &ndash; "Double4" &ndash; "DoubleArray4d"
<li>APT_Asset &ndash; "RenderingAsset" &ndash; "Asset"
<li>APT_FloatArray &ndash; "Float3" &ndash; "FloatArray"
</ul>
...
<p>There are new justification parameters assigned to Beam and Brace elements.
The new set of parameters provides more options to manipulate the physical element in relation to its analytical curve.</p>
<p>Here is a list of parameters and the permitted values for each:</p>
<ul>
<li>BuiltInParameter.YZ_JUSTIFICATION &ndash;
YZJustificationOption.Uniform,
YZJustificationOption.Independent</li>
<li>BuiltInParameter.Y_JUSTIFICATION &ndash;
YJustification.Left,
YJustification.Center,
YJustification.Origin,
YJustification.Right</li>
<li>BuiltInParameter.Y_OFFSET_VALUE &ndash;
double</li>
<li>BuiltInParameter.Z_JUSTIFICATION &ndash;
ZJustification.Top,
ZJustification.Center,
ZJustification.Origin,
ZJustification.Bottom</li>
<li>BuiltInParameter.Z_OFFSET_VALUE &ndash;
double</li>
<li>BuiltInParameter.START_Y_JUSTIFICATION &ndash;
YJustification.Left,
YJustification.Center,
YJustification.Origin,
YJustification.Right</li>
<li>BuiltInParameter.START_Y_OFFSET_VALUE &ndash;
double</li>
<li>BuiltInParameter.START_Z_JUSTIFICATION &ndash;
ZJustification.Top,
ZJustification.Center,
ZJustification.Origin,
ZJustification.Bottom</li>
<li>BuiltInParameter.START_Z_OFFSET_VALUE &ndash;
double</li>
<li>BuiltInParameter.END_Y_JUSTIFICATION &ndash;
YJustification.Left,
YJustification.Center,
YJustification.Origin,
YJustification.Right</li>
<li>BuiltInParameter.END_Y_OFFSET_VALUE &ndash;
double</li>
<li>BuiltInParameter.END_Z_JUSTIFICATION &ndash;
ZJustification.Top,
ZJustification.Center,
ZJustification.Origin,
ZJustification.Bottom</li>
<li>BuiltInParameter.END_Z_OFFSET_VALUE &ndash;
double
</ul>
<p>Previously only Beam elements had any justification parameters.</p>
<p>In Revit 2014, Beams as well as Braces share this set of built-in justification parameters.</p>
<p>The following list shows a mapping from old deprecated justification parameters to new ones:</p>
<ul>
<li>BEAM_H_JUSTIFICATION &ndash; Y_JUSTIFICATION</li>
<li>BEAM_V_JUSTIFICATION &ndash;  Z_JUSTIFICATION</li>
<li>BEAM_V_JUSTIFICATION_OTHER_VALUE (valid only for Other value set to BEAM_V_JUSTIFICATION) &ndash; Z_OFFSET_VALUE (valid for all Z_JUSTIFICATION values)</li>
</ul>
...
<ul>
<li>CurtainCellSetIterator and CurtainCellSet &ndash; Use generic .NET collection classes instead.</li>
<li>PipeMaterialType &ndash; replaced by Material</li>
<li>Batch creation argument class types &ndash; batch creation is not needed with changes to Revit API regeneration</li>
...
<li>ElectricalConnector.SystemType &ndash; query the parameter RBS_ELEC_CIRCUIT_TYPE on ConnectorElement and cast to ElectricalSystemType</li>
<li>DuctConnector</li>
<li>DuctConnector.LinkedConnector &ndash; replaced by ConnectorElement.GetLinkedConnectorElement() and ConnectorElement.SetLinkedConnectorElement()</li>
<li>DuctConnector.SystemType &ndash; query the parameter RBS_DUCT_CONNECTOR_SYSTEM_CLASSIFICATION_PARAM on ConnectorElement and cast to DuctSystemType</li>
<li>PipeConnector</li>
...
<li>PipeConnector.SystemType &ndash; query the parameter RBS_PIPE_CONNECTOR_SYSTEM_CLASSIFICATION_PARAM on ConnectorElement and cast to PipeSystemType</li>
</ul>
<h3>Methods and Properties removed</h3>
<h4>Autodesk.Revit.Creation namespace</h4>
<h5>Application</h5>
<ul>
<li>NewMaterialSet() &ndash; replaced by .net Generic collection classes</li>
<li>NewElementArray() &ndash; replaced by .net Generic collection classes</li>
</ul>
<h5>Document</h5>
<ul>
<li>NewAnnotationSymbol(XYZ ,AnnotationSymbolType ,View) &ndash; replaced by NewFamilyInstance(XYZ, FamilySymbol, View)</li>
<li>NewAreaViewPlan(String,Level,AreaElemType) &ndash; replaced by ViewPlan.CreateAreaPlan()</li>
<li>NewCurtainSystem(ReferenceArray,CurtainSystemType) &ndash; replaced by NewCurtainSystem2(ReferenceArray, CurtainSystemType)</li>
<li>NewElectricalSystem(ElementSet,ElectricalSystemType) &ndash; replaced by NewElectricalSystem(ICollection&lt;ElementId&gt;, ElectricalSystemType)</li>
<li>NewFamilyInstances(List&lt;FamilyInstanceCreationData&gt;) &ndash; replaced by NewFamilyInstances2(List&lt;FamilyInstanceCreationData&gt;)</li>
<li>NewGroup(ElementSet) &ndash; replaced by NewGroup(System.Collections.Generic.ICollection&lt;Autodesk.Revit.DB.ElementId&gt;)</li>
<li>NewRooms(Phase, Int32) &ndash; replaced by NewRooms2(Phase, Int32)</li>
<li>NewRooms(Level,Phase) &ndash; replaced by NewRooms2(Level, Phase)</li>
<li>NewRooms(Level) &ndash; replaced by NewRooms2(Level)</li>
<li>NewRooms(List&lt;RoomCreationData&gt;) &ndash; there is no single equivalent that creates multiple rooms, this is not needed with Revit API control over regeneration</li>
<li>NewSpaces(Phase,Int32) &ndash; replaced by NewSpaces2(Phase, Int32)</li>
<li>NewSpaces(Level,Phase,View) &ndash; replaced by NewSpaces2(Level, Phase, View)</li>
<li>NewTextNotes(List&lt;TextNoteCreationData&gt;) &ndash; replaced by NewTextNote()</li>
<li>NewViewPlan(String,Level,ViewPlanType) &ndash; replaced by ViewPlan.Create(Document, ElementId, ElementId)</li>
<li>NewView3D(XYZ) &ndash; replaced by View3D.CreateIsometric(Document, ElementId)</li>
<li>NewViewSection(BoundingBoxXYZ) &ndash; replaced by ViewSection.CreateDetail()</li>
...
<li>NewWalls(List&lt;ProfiledWallCreationData&gt; dataList) &ndash; there is no single equivalent that creates multiple walls, this is not needed with Revit API control over regeneration</li>
<li>NewWalls(List&lt;RectangularWallCreationData&gt; dataList) &ndash; there is no single equivalent that creates multiple walls, this is not needed with Revit API control over regeneration</li>
</ul>
<h5>FamilyItemFactory</h5>
<ul>
<li>NewDuctConnector(Reference,DuctSystemType) &ndash; replaced by ConnectorElement.CreateDuctConnector()</li>
<li>NewPipeConnector(Reference,PipeSystemType) &ndash; replaced by ConnectorElement.CreatePipeConnector()</li>
<li>NewElectricalConnector(Reference,ElectricalSystemType) &ndash; replaced by ConnectorElement.CreateElectricalConnector()</li>
</ul>
<h4>Autodesk.Revit.DB namespace</h4>
<h5>BaseArray</h5>
<ul>
<li>CopyMembers &ndash; replaced by GetCopiedMemberIds()</li>
<li>OrigMembers &ndash; replaced by GetOriginalMemberIds()</li>
</ul>
<h5>CurtainGrid</h5>
<ul>
<li>UnlockedMullions &ndash; replaced by GetUnlockedMullionIds()</li>
<li>Mullions &ndash; replaced by GetMullionIds()</li>
<li>Cells &ndash; replaced by GetCurtainCells()</li>
<li>UnlockedPanels &ndash; replaced by GetUnlockedPanelIds()</li>
<li>Panels &ndash; replaced by GetPanelIds()</li>
<li>VGridLines &ndash; replaced by GetVGridLineIds()</li>
<li>UGridLines &ndash; replaced by GetUGridLineIds()</li>
</ul>
<h5>CurveElement</h5>
<ul>
<li>LineStyles &ndash; replaced by GetLineStyleIds()</li>
</ul>
<h5>Document</h5>
<ul>
<li>Delete(ElementSet elements) &ndash; replaced by Delete(System.Collections.Generic.ICollection&lt;Autodesk.Revit.DB.ElementId&gt; elementIds)</li>
<li>WorksharingCentralFilename &ndash; replaced by ModelPathUtils.ConvertModelPathToUserVisiblePath(Document.GetWorksharingCentralModelPath())</li>
<li>PrintSettings &ndash; replaced by GetPrintSettingIds()</li>
<li>Element/get_Element &ndash; replaced by GetElement method</li>
</ul>
<h5>Element</h5>
<ul>
<li>PhaseDemolished &ndash; replaced by DemolishedPhaseId</li>
<li>PhaseCreated &ndash; replaced by CreatedPhaseId</li>
</ul>
<h5>FamilyInstance</h5>
<ul>
<li>GetCopings() &ndash; replaced by GetCopingIds()</li>
<li>SetCopings(ElementSet) &ndash; replaced by SetCopingIds(ICollection&lt;ElementId&gt; cutters)</li>
<li>SubComponents &ndash; replaced by GetSubComponentIds()</li>
</ul>
<h5>Floor</h5>
<ul>
<li>SpanDirectionSymbols &ndash; replaced by GetSpanDirectionSymbolIds()</li>
</ul>
<h5>GeometryElement</h5>
<ul>
<li>Objects &ndash; replaced by GetEnumerator()</li>
</ul>
<h5>Group</h5>
<ul>
<li>Ungroup() &ndash; replaced by UngroupMembers()</li>
<li>Members &ndash; replaced by GetMemberIds()</li>
</ul>
<h5>LinearArray</h5>
<ul>
<li>CopyMembers &ndash; replaced by GetCopiedMemberIds()</li>
...
<h5>Material</h5>
<ul>
<li>GetMaterialAspectPropertySet(MaterialAspect) &ndash; replaced by GetStructuralAssetId() and GetThermalAssetId()</li>
<li>SetMaterialAspect(MaterialAspect,ElementId,Boolean) &ndash; replaced by SetStructuralAssetId() and SetThermalAssetId()</li>
<li>SetMaterialAspectToIndependent(MaterialAspect) &ndash; replaced by SetStructuralAssetId() and SetThermalAssetId()</li>
</ul>
<h5>MEPSystem</h5>
<ul>
<li>Remove(ElementSet) &ndash; replaced by Remove(ICollection&lt;ElementId&gt;)</li>
</ul>
<h5>Part</h5>
<ul>
<li>ParentDividedElementId &ndash; no replacement, concept is removed from Revit</li>
<li>OriginalDividedElementId &ndash; no replacement, concept is removed from Revit</li>
<li>GetDividedParents() &ndash; no replacement, concept is removed from Revit</li>
</ul>
<h5>PartMaker</h5>
<ul>
<li>IsElementDivided(ElementId elemId) &ndash; replaced by IsSourceElement(ElementId)</li>
<li>GetDividedElementIds() &ndash; replaced by GetSourceElementIds()</li>
<li>SetDividedElementIds(ICollection&lt;ElementId&gt;) &ndash; replaced by SetSourceElementIds(ICollection&lt;ElementId&gt;)</li>
</ul>
<h5>PartUtils</h5>
<ul>
<li>AreElementsValidForDivide(Document, ICollection&lt;ElementId&gt;) &ndash; replaced by ArePartsValidForDivide(Document, ICollection&lt;ElementId&gt;)</li>
<li>AreElementsValidIntersectingReferences(Document, ICollection&lt;ElementId&gt;) &ndash; replaced by PartMakerMethodToDivideVolumes.AreElementsValidIntersectingReferences(Document, ICollection&lt;ElementId&gt;)</li>
<li>IsValidSketchPlane(Document, ElementId) &ndash; replaced by PartMakerMethodToDivideVolumes.IsValidSketchPlane(Document, ElementId)</li>
<li>SetOffsetForIntersectingReference() &ndash; replaced by PartMakerMethodToDivideVolumes.SetOffsetForIntersectingReference()</li>
<li>GetOffsetForIntersectingReference() &ndash; replaced by PartMakerMethodToDivideVolumes.GetOffsetForIntersectingReference()</li>
<li>PartMakerUsesReference() &ndash; replaced by PartMakerMethodToDivideVolumes.PartMakerUsesReference()</li>
<li>IsMaxDivisionDepthReached(Document, ElementId) &ndash; no replacement, concept is removed from Revit</li>
<li>GetDividedParents(Part) &ndash; no replacement, concept is removed from Revit</li>
<li>PlanTopology</li>
<li>Rooms &ndash; replaced by GetRoomIds()</li>
</ul>
<h5>PropertySetElement</h5>
<ul>
<li>Create(Document, MaterialAspect) &ndash; replaced by Create(Document, StructuralAsset)</li>
</ul>
<h5>RadialArray</h5>
<ul>
<li>CopyMembers &ndash; replaced by GetCopiedMemberIds()</li>
...
<ul>
<li>UpdateSpatialFieldPrimitive(Int32,FieldDomainPoints,FieldValues) &ndash; replaced by UpdateSpatialFieldPrimitive(Int32, FieldDomainPoints, FieldValues, Int32)</li>
<li>SetUnits(IList&lt;string&gt;, IList&lt;double&gt;) &ndash; replaced by AnalysisResultSchema.SetUnits() and SetResultSchema()</li>
</ul>
<h5>View</h5>
<ul>
<li>ApplyTemplate(View viewTemplate) &ndash; replaced by ViewTemplateId/ApplyViewTemplateParameters(View viewTemplate)</li>
<li>Hide(ElementSet elemSet) &ndash; replaced by HideElements(System::Collections::Generic::ICollection&lt;Autodesk::Revit::DB::ElementId^&gt;^ elementIdSet)</li>
<li>Unhide(ElementSet elemSet) &ndash; replaced by UnhideElements(System::Collections::Generic::ICollection&lt;Autodesk::Revit::DB::ElementId^&gt;^ elementIdSet)</li>
</ul>
<h5>View3D</h5>
<ul>
<li>EyePosition &ndash; replaced by ViewOrientation3D.EyePosition/View.Origin</li>
<li>ViewSheet</li>
<li>AddView(View,UV) &ndash; replaced by Viewport.Create(Document, ElementId, ElementId, XYZ)</li>
</ul>
<h4>Autodesk.Revit.DB.Plumbing namespace</h4>
<h5>PipeType</h5>
<ul>
<li>Roughness &ndash; replaced by Segment.Roughness</li>
<li>Material &ndash; replaced by PipeSegment.MaterialId</li>
</ul>
<h4>Autodesk.Revit.DB.Structure namespace</h4>
<h5>AnalyticalModel</h5>
<ul>
<li>CanDisable() &ndash; no replacement, concept removed from Revit</li>
<li>IsValidAnalyticalProjectionType(AnalyticalDirection,AnalyticalProjectionType) &ndash; replaced by IsValidProjectionType(AnalyticalElementSelector, AnalyticalDirection, AnalyticalProjectionType)</li>
</ul>
<h5>AreaReinforcement</h5>
<ul>
<li>NumBarDescriptions &ndash; replaced by GetRebarInSystemIds()</li>
<li>BarDescription &ndash; replaced GetRebarInSystemIds()</li>
<li>Curves &ndash; replaced by GetCurveElementIds()</li>
</ul>
<h5>BeamSystem</h5>
<ul>
<li>GetAllBeams() &ndash; replaced by GetBeamIds()</li>
</ul>
<h5>PathReinforcement</h5>
<ul>
<li>BarDescription &ndash; replaced by GetRebarInSystemIds()</li>
<li>Curves &ndash; replaced by GetCurveElementIds()</li>
</ul>
<h5>Rebar</h5>
<ul>
<li>GetCenterlineCurves(Boolean) &ndash; replaced by GetCenterlineCurves(Boolean,Boolean,Boolean)</li>
<li>DistributionPath &ndash; replaced by GetDistributionPath()</li>
<li>RebarShape &ndash; replaced by RebarShapeId</li>
<li>Host &ndash; replaced by Rebar.GetHostId() and SetHostId(Document, ElementId)</li>
<li>BarType &ndash; replaced by Element.GetTypeId() and Element.ChangeTypeId(ElementId)</li>
</ul>
<a name="2"></a>
...
<ul>
<li>WorksharingUtils.CheckoutElements &ndash; Obtains ownership for the current user of as many specified elements as possible.</li>
<li>WorksharingUtils.CheckoutWorksets &ndash; Obtains ownership for the current user of as many specified worksets as possible.</li>
<li>WorksharingUtils.RelinquishOwnership &ndash; Relinquishes ownership by the current user of as many specified elements and worksets as possible, and grants element ownership requested by other users on a first come, first served basis.</li>
</ul>
...
<ul>
<li>MultiReferenceAnnotation &ndash; the annotation object instance.  This class includes a reference to the associated dimension and tag element.</li>
<li>MultiReferenceAnnotationType &ndash; the annotation type.   The type specifies the tag and dimension types to be used in the multi-reference annotation, as well as associated display settings.</li>
<li>MultiReferenceAnnotationOptions &ndash; an options class used to create a new MultiReferenceAnnotation, including specification of the associated elements and options for the dimension and tag placement.</li>
<li>IndependentTag.MultiReferenceAnnotationId  &ndash; returns  the ElementId of the MultiReferenceAnnotation that owns a tag.</li>
<li>Dimension.MultiReferenceAnnotationId &ndash; returns the ElementId of the MultiReferenceAnnotation that owns a dimension.</li>
</ul>
...
<p>After placing a new .addin manifest file into one of the dedicated addins folders, the running Revit session will attempt to load the corresponding addin.  Loaded ExternalCommands will be added to the External Tools pulldown menu.  ExternalApplication and ExternalDBApplication OnStartup methods will be executed upon loading.  An addin's installer may leverage this feature &ndash; but it must do so by creating the new .addin file at the end of installation to the dedicated Revit addin folders (the installer must ensure that the addin's assembly is already deployed to the target machine and the assembly path can be resolved in the add-in manifest file). </p>
...
<h2>Parameters</h2>
<h3>Shared parameter &ndash; create with specified GUID</h3>
<p>The new method</p>
<ul>
...
<ul>
<li>IsValidRegion() &ndash; Identifies whether the points can construct a valid region for a topography surface.</li>
<li>ArePointsDistinct() &ndash; Identifies whether the input points are distinct in XY location.</li>
</ul>
...
<ul>
<li>SiteSubRegion.Create() &ndash; creates a new subregion given a boundary consisting of one or more curve loops.</li>
<li>SiteSubRegion.IsValidBoundary() &ndash; validates the input boundary for a new subregion</li>
<li>SiteSubRegion.GetBoundary() &ndash; returns the boundary curves</li>
<li>SiteSubRegion.SetBoundary() &ndash; sets the boundary for the subregion</li>
<li>SiteSubRegion.TopographySurface &ndash; the TopographySurface element which this subregion represents</li>
<li>SiteSubRegion.HostId &ndash; the identifier of the topography surface hosting this subregion</li>
</ul>
<h3>BuildingPad</h3>
...
<ul>
<li>BuildingPad.Create() &ndash; Creates a new BuildingPad given a boundary, type and level.</li>
<li>BuildingPad.GetBoundary() &ndash; Returns the sketched boundary curves.</li>
<li>BuildingPad.SetBoundary() &ndash; Assigns a new boundary to the BuildingPad.</li>
<li>BuildingPad.HostId &ndash; The element id of the topography surface hosting this BuildingPad.</li>
</ul>
...
<ul>
<li>BuildingPadType.CreateDefault() &ndash; Creates a new default BuildingPadType in the document.</li>
</ul>
<h2>MEP</h2>
...
<li>AreaReinforcement.IsUnobscuredInView &ndash; checks if Area Reinforcement is shown unobscured in a view.</li>
<li>AreaReinforcement.SetUnobscuredInView &ndash; sets Area Reinforcement to be shown unobscured in a view.</li>
</ul>
...
<li>PathReinforcement .IsUnobscuredInView &ndash; checks if PathReinforcement is shown unobscured in a view.</li>
<li>PathReinforcement .SetUnobscuredInView &ndash; sets PathReinforcement to be shown unobscured in a view.</li>
</ul>
<h4>FabricArea  </h4>
<p>FabricArea has several new methods and properties.</p>
<ul>
<li>FabricArea.Create &ndash; now supports an origin point of direction parameter.</li>
<li>FabricArea.GetReinforcementRoundingManager &ndash; returns an object for managing reinforcement rounding override settings.</li>
</ul>
<h4>FabricSheet </h4>
<p>FabricSheet has several new methods and properties.</p>
<ul>
<li>FabricSheet.Create() &ndash; new static factory method for creation.</li>
<li>FabricSheet.GetLocalCoordinateSystem()</li>
<li>FabricSheet.SetLocalCoordinateSystem()</li>
<li>FabricSheet.PlaceInHost()</li>
<li>FabricSheet.GetReinforcementRoundingManager() &ndash; returns an object for managing reinforcement rounding override settings.</li>
<li>FabricSheet.HostId</li>
<li>FabricSheet.FabricLocation &ndash; the FabricSheet location in the host.</li>
<li>FabricSheet.CoverOffset &ndash; the additional cover offset of the FabricSheet.</li>
<li>FabricSheet.IsCoverOffsetValid() &ndash; identifies if the specified value is valid for use as a cover offset.</li>
</ul>
<h4>FabricSheetType </h4>
<ul>
<li>FabricSheetType.GetReinforcementRoundingManager() &ndash; returns an object for managing reinforcement rounding override settings.</li>
</ul>
<h4>Rebar </h4>
<p>Rebar has several new methods and properties.</p>
<ul>
<li>Rebar.ComputeDrivingCurves() &ndash; compute the driving curves.</li>
<li>Rebar.GetRebarConstraintsManager() &ndash; returns an object for managing the external constraints on the Rebar element.</li>
<li>Rebar.GetReinforcementRoundingManager() &ndash; returns an object for managing reinforcement rounding override settings.</li>
<li>Rebar.HookAngleMatchesRebarShapeDefinition() &ndash; checks that the hook angle of the specified RebarHookType matches the hook angle used in the Rebar's RebarShape at the specified end of the bar.</li>
<li>Rebar.CanUseHookType &ndash; checks if the specified RebarHookType id is of a valid RebarHookType for the Rebar's RebarBarType.</li>
<li>Rebar.ConstraintsCanBeEdited &ndash; returns true, if the Rebar element's external constraints are available for editing.</li>
<li>Rebar.GetHookOrientation() &ndash; returns the orientation of the hook plane at the start or at the end of the rebar with respect to the orientation of the first or the last curve and the plane normal.</li>
<li>Rebar.SetHookOrientation() &ndash; defines the orientation of the hook plane at the start or at the end of the rebar with respect to the orientation of the first or the last curve and the plane normal.</li>
</ul>
<p>RebarType has several new methods and properties.</p>
<ul>
<li>RebarType.SetHookTangentLength() &ndash; identifies the hook tangent length for a hook type.</li>
<li>RebarType.GetReinforcementRoundingManager() &ndash; returns an object for managing reinforcement rounding override settings.</li>
<li>RebarBendData – new constructor to specify hook orientation.</li>
</ul>
<p>RebarHandleType &ndash; a new enum to represent  the various types of handles on a Rebar instance that can be joined to References.</p>
<p>RebarConstrainedHandle &ndash; a new class to represent a handle on a Rebar that can be joined to a reference.</p>
<p>RebarConstraintType &ndash; a new enum to represent the various types of constraints that can be applied to a RebarConstrainedHandle.</p>
<p>RebarConstraintTargetHostFaceType &ndash; a new enum  to identify the individual face on a host element to which a Rebar handle is constrained.</p>
<p>RebarConstraint &ndash; a new class representing a constraint on the position of a Rebar Element or one of its handles.</p>
<p>RebarConstraintsManager &ndash; a  new class used to obtain information about the constrained shape handles (RebarConstrainedHandles) on a Rebar element.</p>
<p>RebarDeformationType &ndash; new enum representing the type of deformation of rebar.</p>
<p>RebarHookType.HookAngleInDegrees &ndash; a new property representing the angle of a rebar hook.</p>
<h4>RebarInSystem</h4>
<ul>
<li>RebarInSystem.getReinforcementRoundingManager &ndash; returns an object for managing reinforcement rounding override settings.</li>
<li>RebarInSystem.setUnobscuredInView - sets the element to be shown unobscured in a view.</li>
</ul>
<h4>RebarShape</h4>
<ul>
<li>RebarShape.GetDefaultHookAngle &ndash; get the hook angle, expressed as an integral number of degrees (common values are 0, 90, 135, and 180).</li>
<li>RebarShape.GetDefaultHookOrientation &ndash; gets the default rebar hook orientation.</li>
</ul>
<p>ReinforcementRoundingSource &ndash; a new enum listing the possible sources for reinforcement rounding overrides.</p>
<p>ReinforcementRoundingManager &ndash; a new class providing access to reinforcement rounding overrides for structural elements.</p>
<p>RebarRoundingManager &ndash; new class providing access to element reinforcement roundings overrides.</p>
<p>FabricRoundingManager &ndash; a new class providing access to element reinforcement roundings overrides.</p>
<h4>ReinforcementSettings</h4>
<ul>
<li>ReinforcementSettings.GetRebarRoundingManager &ndash; returns an object for managing reinforcement rounding override settings used by RebarBarTypes, Rebar and RebarInSystem elements.</li>
<li>ReinforcementSettings.GetFabricRoundingManager &ndash; returns an object for managing reinforcement rounding override settings used by FabricSheetType and FabricSheet elements. </li>
</ul>
<h2>Custom Export</h2>
...
<a name="3"></a>
<h1>Small Enhancements &amp; Interface Changes</h1>
...
<ul>
<li>FreeFormElement.Create() &ndash; creates a new FreeForm element.</li>
<li>FreeFormElement.SetFaceOffset() &ndash; offsets a planar face a certain distance in the face normal direction.</li>
</ul>
...
<p>Note that the MarkerPosition property is no longer settable &ndash; this position is determined automatically.</p>
...
<p>For the methods GetAddedElementIds()/GetModifiedElementIds() &ndash; internal Revit element ids that are not visible to UI and API are now excluded from the return set.</p>
...
<p>I hope this is enough for you  :-)</p>
<p>Cool, huh?</p>
