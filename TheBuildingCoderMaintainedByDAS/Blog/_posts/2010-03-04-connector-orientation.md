...
date: "2010-03-04 05:00:00"
author: "Jeremy Tammik"
categories:
  - "Geometry"
  - "Parameters"
  - "RME"
original_url: "https://thebuildingcoder.typepad.com/blog/2010/03/connector-orientation.html "
typepad_basename: "connector-orientation"
typepad_status: "Publish"
---

<p>I am still looking through all the interesting cases my colleagues dealt with during my absence.
...
<p><strong>Answer:</strong> The width is relative to the x axis and the height is relative to the y axis of the coordinate system of the connector. There is a difference between the width and height of the connector and the width and height that is exposed in the user interface options bar. 
