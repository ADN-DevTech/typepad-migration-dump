---
layout: "post"
title: "Compiling the Revit 2019 SDK Samples"
...
categories:
  ...
  - "SDK Samples"
  - "Update"
original_url: "https://thebuildingcoder.typepad.com/blog/2018/04/compiling-the-revit-2019-sdk-samples.html "
typepad_basename: "compiling-the-revit-2019-sdk-samples"
...
<p>In fact, there
were 
<a href="http://thebuildingcoder.typepad.com/files/revit_2019_sdk_samples_errors_warnings_1.txt">82 projects succeeded and 4 failed with 2 errors and 70 warnings, cf. the error and warning list</a>.</p>
...
to 
<a href="http://thebuildingcoder.typepad.com/files/revit_2019_sdk_samples_errors_warnings_2.txt">183 succeeded and 3 failed with 1 error and 40 warnings</a>.</p>
...
<p>This results in 
<a href="http://thebuildingcoder.typepad.com/files/revit_2019_sdk_samples_errors_warnings_3.txt">0 errors, 29 warnings, 184 succeeded, 2 failed</a>.</p>
...
<p>That reduced the number of warnings from 29 to 25, so we now have 
<a href="http://thebuildingcoder.typepad.com/files/revit_2019_sdk_samples_errors_warnings_4.txt">0 errors, 25 warnings, 184 succeeded, 2 failed</a>.</p>

<p>I did the same for the RebarFreeForm project, resulting in 21 warnings, leaving 
<a href="http://thebuildingcoder.typepad.com/files/revit_2019_sdk_samples_errors_warnings_5.txt">0 errors, 21 warnings, 184 succeeded, 2 failed</a>.</p>
...
<p>I simply removed it entirely, resulting in 19 warnings, leaving 
<a href="http://thebuildingcoder.typepad.com/files/revit_2019_sdk_samples_errors_warnings_6.txt">0 errors, 19 warnings, 184 succeeded, 2 failed</a>.</p>
...
<p><a class="asset-img-link"  href="http://thebuildingcoder.typepad.com/.a/6a00e553e16897883301b7c9606b36970b-popup" onclick="window.open( this.href, '_blank', 'width=640,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0' ); return false"><img class="asset  asset-image at-xid-6a00e553e16897883301b7c9606b36970b img-responsive" style="width: 232px; display: block; margin-left: auto; margin-right: auto;" alt="SampleCommandsSteelElements references" title="SampleCommandsSteelElements references" src="/assets/image_3376b0.jpg" /></a><br /></p>
...
see
<a href="http://thebuildingcoder.typepad.com/files/revit_2019_sdk_samples_errors_warnings_7.txt">185 succeeded, 1 failed, 7 errors, 9 warnings</a>.</p>
...
<p><a class="asset-img-link"  href="http://thebuildingcoder.typepad.com/.a/6a00e553e16897883301b8d2eaa714970c-popup" onclick="window.open( this.href, '_blank', 'width=640,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0' ); return false"><img class="asset  asset-image at-xid-6a00e553e16897883301b8d2eaa714970c img-responsive" style="width: 314px; display: block; margin-left: auto; margin-right: auto;" alt="AppearanceAssetEditing build properties" title="AppearanceAssetEditing build properties" src="/assets/image_1bd960.jpg" /></a><br /></p>
...
<p>Zero errors now, but 
<a href="http://thebuildingcoder.typepad.com/files/revit_2019_sdk_samples_errors_warnings_8.txt">16 warnings still remain</a>.</p>
