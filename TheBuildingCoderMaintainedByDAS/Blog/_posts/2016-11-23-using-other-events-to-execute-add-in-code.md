---
layout: "post"
title: "Using Other Events to Execute Add-In Code"
date: "2016-11-23 05:00:00"
author: "Jeremy Tammik"
categories:
  - "Events"
  - "Getting Started"
original_url: "https://thebuildingcoder.typepad.com/blog/2016/11/using-other-events-to-execute-add-in-code.html "
typepad_basename: "using-other-events-to-execute-add-in-code"
...
<p>The most common and obvious way to get into a valid Revit API context, and the most commonly used event is the one to launch an external command, which calls the <code>IExternalCommand</code> <code>Execute</code> handler method.</p>
...
<p><a class="asset-img-link"  style="display: inline;" href="http://thebuildingcoder.typepad.com/.a/6a00e553e16897883301b8d23ce15f970c-popup" onclick="window.open( this.href, '_blank', 'width=640,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0' ); return false"><img class="asset  asset-image at-xid-6a00e553e16897883301b8d23ce15f970c img-responsive" alt="Apples" title="Apples" src="/assets/image_95c939.jpg" /></a><br /></p>
