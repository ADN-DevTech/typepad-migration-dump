...
categories:
  ...
  - "External"
  - "Plugin"
original_url: "https://thebuildingcoder.typepad.com/blog/2012/06/retrieve-embedded-resource-image.html "
typepad_basename: "retrieve-embedded-resource-image"
...
<p>Before moving back to Revit, here is an interesting thing to point out that you should not miss: one of the "rarest of predictable celestial phenomena" is taking place tomorrow, June 5: a 

<a href="http://en.wikipedia.org/wiki/Transit_of_Venus,_2012">
transit of Venus in front of the sun</a>.

<p>Now let me finally get to the less celestial, not-so-spiritual and rather down-to-earth Revit API item before I pack and go.
...
<span class="asset  asset-generic at-xid-6a00e553e1689788330168ec101477970c"><a href="http://thebuildingcoder.typepad.com/files/stringsearch2013.zip">updated version of the source code for Revit 2013</a></span>, 
