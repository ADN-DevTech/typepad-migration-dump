---
layout: "post"
title: "What's New in the Revit 2018 API"
date: "2017-04-25 05:00:00"
...
categories:
  ...
  - "SDK Samples"
  - "Update"
original_url: "https://thebuildingcoder.typepad.com/blog/2017/04/whats-new-in-the-revit-2018-api.html "
typepad_basename: "whats-new-in-the-revit-2018-api"
typepad_status: "Publish"
---

<script src="https://cdn.rawgit.com/google/code-prettify/master/loader/run_prettify.js" type="text/javascript"></script>

<p>The Revit 2018 API includes numerous exciting enhancements for add-in developers.</p>

<p>The highlights were pointed out in
the <a href="http://thebuildingcoder.typepad.com/blog/2017/03/revitlookup-enhancements-future-revit-and-other-api-news.html">DevDays Online API news</a> presentation
and video recording.</p>

<p>That information is based on the contents of the <em>Revit Platform API Changes and Additions.docx</em> document included with
the <a href="http://thebuildingcoder.typepad.com/blog/2017/04/revitlookup-2018-and-forge-devcon-cfp.html#2">Revit 2018 software developers kit</a> or 
SDK available from 
the <a href="http://www.autodesk.com/developrevit">Revit Developer Centre</a>.</p>

<p>It is also provided in the section on <em>What's New</em> in the Revit 2018 API help file <code>RevitAPI.chm</code> included with the SDK:</p>

<p><center></p>

<p><a class="asset-img-link"  style="display: inline;" href="http://thebuildingcoder.typepad.com/.a/6a00e553e16897883301b8d27bad6d970c-popup" onclick="window.open( this.href, '_blank', 'width=640,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0' ); return false"><img class="asset  asset-image at-xid-6a00e553e16897883301b8d27bad6d970c image-full img-responsive" alt="Revit 2018 API help on What's New" title="Revit 2018 API help on What's New" src="/assets/image_eb61f8.jpg" border="0" /></a><br /></p>
...
online <a href="http://help.autodesk.com/view/RVT/2018/ENU/?guid=GUID-F0A122E0-E556-4D0D-9D0F-7E72A9315A42">Revit API Developers Guide</a> included 
in the <a href="http://help.autodesk.com/view/RVT/2018/ENU">Revit 2018 Help</a>.</p>

<h4><a name="0"></a>What's New in Previous Versions</h4>
...
<h3><a name="1"></a>Table of Contents</h3>

<p>I implemented
the <a href="#4">Python script <code>number_html_headings.py</code> described below</a> to
generate the HTML heading numbering for this table of contents:</p>

<ul>
<li><a href="#2">API changes</a>
<ul>
<li><a href="#2.1">API enabled in perspective views</a>
<ul>
<li><a href="#2.1.1">Element modifications and contextual commands</a></li>
<li><a href="#2.1.2">External commands and applications</a></li>
</ul></li>
<li><a href="#2.2">Subelements</a>
<ul>
<li><a href="#2.2.3">References and selection of subelements</a></li>
</ul></li>
<li><a href="#2.3">Changes to APIs for accessing version</a></li>
<li><a href="#2.4">Asset API Changes</a></li>
<li><a href="#2.5">Dynamic Updaters on Reload Latest</a></li>
<li><a href="#2.6">Export to DWG/DXF API change</a></li>
<li><a href="#2.7">UIDocument.PromptForFamilyInstancePlacement() behavioral change</a></li>
<li><a href="#2.8">IndependentTag API changes</a></li>
<li><a href="#2.9">Shared Coordinates API changes</a></li>
<li><a href="#2.10">New DirectShape behaviors</a></li>
<li><a href="#2.11">Rebar API Changes</a></li>
<li><a href="#2.12">FabricSheet API Changes</a></li>
<li><a href="#2.13">Structural Section API Changes</a></li>
<li><a href="#2.14">ElectricalSystem API changes</a></li>
<li><a href="#2.15">Pipe Pressure Loss Calculation change</a></li>
<li><a href="#2.16">Corrected names of AutoRouteFailures values</a></li>
<li><a href="#2.17">Obsolete API removal</a>
<ul>
<li><a href="#2.17.4">Classes</a></li>
<li><a href="#2.17.5">Methods</a></li>
<li><a href="#2.17.6">Properties</a></li>
<li><a href="#2.17.7">Enumerated types</a></li>
</ul></li>
</ul></li>
<li><a href="#3">API additions</a>
<ul>
<li><a href="#3.18">API to get list of reviewable warnings from a Document</a></li>
<li><a href="#3.19">API access to FamilyInstance references</a></li>
<li><a href="#3.20">Multistory Stairs API</a>
<ul>
<li><a href="#3.20.8">Railings API additions related to MultistoryStairs</a></li>
</ul></li>
<li><a href="#3.21">Dimension API additions</a>
<ul>
<li><a href="#3.21.9">DimensionEqualityLabelFormating API</a></li>
<li><a href="#3.21.10">UnitsFormatOptions in DimensionType</a></li>
<li><a href="#3.21.11">OrdinateDimensionSetting</a></li>
</ul></li>
<li><a href="#3.22">SpatialElementTag API additions</a></li>
<li><a href="#3.23">Geometry API additions</a>
<ul>
<li><a href="#3.23.12">Surface and Face API</a></li>
<li><a href="#3.23.13">RevolvedSurface API</a></li>
<li><a href="#3.23.14">RuledSurface API</a></li>
</ul></li>
<li><a href="#3.24">Level API addition</a></li>
<li><a href="#3.25">Dockable Frame API Additions</a></li>
<li><a href="#3.26">DirectContext3D for display of externally managed 3D graphics in Revit</a>
<ul>
<li><a href="#3.26.15">View update for DirectContext3D</a></li>
</ul></li>
<li><a href="#3.27">Coordination Model elements</a></li>
<li><a href="#3.28">Shared Coordinates API additions</a>
<ul>
<li><a href="#3.28.16">Acquire and Publish coordinates API additions</a></li>
<li><a href="#3.28.17">SiteLocation API additions</a></li>
<li><a href="#3.28.18">ProjectLocation API additions</a></li>
<li><a href="#3.28.19">Revit Link API additions</a></li>
</ul></li>
<li><a href="#3.29">Link API additions</a>
<ul>
<li><a href="#3.29.20">External Resource framework additions</a></li>
<li><a href="#3.29.21">CADLinkType additions</a></li>
<li><a href="#3.29.22">ImportInstance additions</a></li>
<li><a href="#3.29.23">IFC Link API additions</a></li>
</ul></li>
<li><a href="#3.30">Workshared operation progress changed events</a>
<ul>
<li><a href="#3.30.24">WorksharedOperationProgressChangedEventArgs</a></li>
<li><a href="#3.30.25">DocumentSaveToLocalProgressChangedEventArgs</a></li>
<li><a href="#3.30.26">DataTransferProgressChangedEventArgs</a></li>
<li><a href="#3.30.27">DocumentReloadLatestProgressChangedEventArgs</a></li>
<li><a href="#3.30.28">DocumentSaveToCentralProgressChangedEventArgs</a></li>
<li><a href="#3.30.29">CreateRelatedFileProgressChangedEventArgs</a></li>
</ul></li>
<li><a href="#3.31">Events related to linked resources</a>
<ul>
<li><a href="#3.31.30">LinkedResourceOpeningEventArgs</a></li>
<li><a href="#3.31.31">LinkedResourceOpenedEventArgs</a></li>
</ul></li>
<li><a href="#3.32">Events related to parallel View Export</a></li>
<li><a href="#3.33">DWG export API additions</a>
<ul>
<li><a href="#3.33.32">ExportDWGSettings API additions</a></li>
</ul></li>
<li><a href="#3.34">Part API additions</a></li>
<li><a href="#3.35">Freeform Rebar API additions</a></li>
<li><a href="#3.36">Custom Service for Freeform Rebar Definition</a></li>
<li><a href="#3.37">HVACSpaceType and Space air ventilation API</a></li>
<li><a href="#3.38">Energy Analysis API additions</a></li>
<li><a href="#3.39">Electrical API additions</a>
<ul>
<li><a href="#3.39.33">Electrical Circuit Path API</a></li>
<li><a href="#3.39.34">PanelScheduleView API</a></li>
</ul></li>
<li><a href="#3.40">MEPAnalyticalConnection API additions</a></li>
<li><a href="#3.41">Fabrication API additions</a>
<ul>
<li><a href="#3.41.35">Hanger Rod additions</a></li>
<li><a href="#3.41.36">Placing and splitting fabrication parts</a></li>
<li><a href="#3.41.37">Fabrication Part export additions</a></li>
<li><a href="#3.41.38">Fabrication Part status additions</a></li>
<li><a href="#3.41.39">Fabrication part comparison</a></li>
<li><a href="#3.41.40">Fabrication Part ancillary usage additions</a></li>
<li><a href="#3.41.41">Fabrication Part custom data additions</a></li>
<li><a href="#3.41.42">FabricationConfiguration additions</a></li>
<li><a href="#3.41.43">Routing exclusions additions</a></li>
<li><a href="#3.41.44">FabricationServiceButton addition</a></li>
</ul></li>
</ul></li>
</ul>
...
<p><a name="2.1"></a><h2>API enabled in perspective views</h2></p>

<p><a name="2.1.1"></a><h3>Element modifications and contextual commands</h3></p>
...
<p><a name="2.1.2"></a><h3>External commands and applications</h3></p>
...
<p><a name="2.2"></a><h2>Subelements</h2></p>
...
<p><a name="2.2.3"></a><h3>References and selection of subelements</h3></p>
...
<p><a name="2.3"></a><h2>Changes to APIs for accessing version</h2></p>
...
<p><a name="2.4"></a><h2>Asset API Changes</h2></p>
...
<p><a name="2.7"></a><h2>UIDocument.PromptForFamilyInstancePlacement() behavioral change</h2></p>
...
<p><a name="2.8"></a><h2>IndependentTag API changes</h2></p>
...
<p><a name="2.9"></a><h2>Shared Coordinates API changes</h2></p>
...
<p><a name="2.10"></a><h2>New DirectShape behaviors</h2></p>
...
<p><a name="2.11"></a><h2>Rebar API Changes</h2></p>
...
<p><a name="2.12"></a><h2>FabricSheet API Changes</h2></p>
...
<p><a name="2.13"></a><h2>Structural Section API Changes</h2></p>
...
<p><a name="2.14"></a><h2>ElectricalSystem API changes</h2></p>
...
<p><a name="2.15"></a><h2>Pipe Pressure Loss Calculation change</h2></p>
...
<p><a name="2.16"></a><h2>Corrected names of AutoRouteFailures values</h2></p>
...
<p><a name="2.17"></a><h2>Obsolete API removal</h2></p>
...
<p><a name="2.17.4"></a><h3>Classes</h3></p>
...
<p><a name="2.17.5"></a><h3>Methods</h3></p>
...
<p><a name="2.17.6"></a><h3>Properties</h3></p>
...
<p><a name="2.17.7"></a><h3>Enumerated types</h3></p>
...
<p><a name="3.18"></a><h2>API to get list of reviewable warnings from a Document</h2></p>
...
<p><a name="3.19"></a><h2>API access to FamilyInstance references</h2></p>
...
<p><a name="3.20"></a><h2>Multistory Stairs API</h2></p>
...
<p><a name="3.20.8"></a><h3>Railings API additions related to MultistoryStairs</h3></p>
...
<p><a name="3.21"></a><h2>Dimension API additions</h2></p>

<p><a name="3.21.9"></a><h3>DimensionEqualityLabelFormating API</h3></p>
...
<p><a name="3.21.10"></a><h3>UnitsFormatOptions in DimensionType</h3></p>
...
<p><a name="3.21.11"></a><h3>OrdinateDimensionSetting</h3></p>
...
<p><a name="3.22"></a><h2>SpatialElementTag API additions</h2></p>
...
<p><a name="3.23"></a><h2>Geometry API additions</h2></p>

<p><a name="3.23.12"></a><h3>Surface and Face API</h3></p>
...
<p><a name="3.23.13"></a><h3>RevolvedSurface API</h3></p>
...
<p><a name="3.23.14"></a><h3>RuledSurface API</h3></p>
...
<p><a name="3.24"></a><h2>Level API addition</h2></p>
...
<p><a name="3.25"></a><h2>Dockable Frame API Additions</h2></p>
...
<p><a name="3.26"></a><h2>DirectContext3D for display of externally managed 3D graphics in Revit</h2></p>
...
<p><a name="3.26.15"></a><h3>View update for DirectContext3D</h3></p>
...
<p><a name="3.27"></a><h2>Coordination Model elements</h2></p>
...
<p><a name="3.28"></a><h2>Shared Coordinates API additions</h2></p>

<p><a name="3.28.16"></a><h3>Acquire and Publish coordinates API additions</h3></p>
...
<p><a name="3.28.17"></a><h3>SiteLocation API additions</h3></p>
...
<p><a name="3.28.18"></a><h3>ProjectLocation API additions</h3></p>
...
<p><a name="3.28.19"></a><h3>Revit Link API additions</h3></p>
...
<p><a name="3.29"></a><h2><h2>Link API additions</h2></p>

<p><a name="3.29.20"></a><h3>External Resource framework additions</h3></p>
...
<p><a name="3.29.21"></a><h3>CADLinkType additions</h3></p>
...
<p><a name="3.29.22"></a><h3>ImportInstance additions</h3></p>
...
<p><a name="3.29.23"></a><h3>IFC Link API additions</h3></p>
...
<p><a name="3.30"></a><h2><h2>Workshared operation progress changed events</h2></p>
...
<p><a name="3.30.24"></a><h3>WorksharedOperationProgressChangedEventArgs</h3></p>
...
<p><a name="3.30.25"></a><h3>DocumentSaveToLocalProgressChangedEventArgs</h3></p>
...
<p><a name="3.30.26"></a><h3>DataTransferProgressChangedEventArgs</h3></p>
...
<p><a name="3.30.27"></a><h3>DocumentReloadLatestProgressChangedEventArgs</h3></p>
...
<p><a name="3.30.28"></a><h3>DocumentSaveToCentralProgressChangedEventArgs</h3></p>
...
<p><a name="3.30.29"></a><h3>CreateRelatedFileProgressChangedEventArgs</h3></p>
...
<p><a name="3.31"></a><h2><h2>Events related to linked resources</h2></p>
...
<p><a name="3.31.30"></a><h3>LinkedResourceOpeningEventArgs</h3></p>
...
<p><a name="3.31.31"></a><h3>LinkedResourceOpenedEventArgs</h3></p>
...
<p><a name="3.32"></a><h2><h2>Events related to parallel View Export</h2></p>
...
<p><a name="3.33"></a><h2>DWG export API additions</h2></p>
...
<p><a name="3.33.32"></a><h3><h3>ExportDWGSettings API additions</h3></p>
...
<p><a name="3.34"></a><h2>Part API additions</h2></p>
...
<p><a name="3.35"></a><h2>Freeform Rebar API additions</h2></p>
...
<p><a name="3.36"></a><h2>Custom Service for Freeform Rebar Definition</h2></p>
...
<p><a name="3.37"></a><h2>HVACSpaceType and Space air ventilation API</h2></p>
...
<p><a name="3.38"></a><h2>Energy Analysis API additions</h2></p>
...
<p><a name="3.39"></a><h2>Electrical API additions</h2></p>

<p><a name="3.39.33"></a><h3><h3>Electrical Circuit Path API</h3></p>
...
<p><a name="3.39.34"></a><h3><h3>PanelScheduleView API</h3></p>
...
<p><a name="3.40"></a><h2>MEPAnalyticalConnection API additions</h2></p>
...
<p><a name="3.41"></a><h2>Fabrication API additions</h2></p>

<p><a name="3.41.35"></a><h3>Hanger Rod additions</h3></p>
...
<p><a name="3.41.36"></a><h3>Placing and splitting fabrication parts</h3></p>
...
<p><a name="3.41.37"></a><h3>Fabrication Part export additions</h3></p>
...
<p><a name="3.41.38"></a><h3>Fabrication Part status additions</h3></p>
...
<p><a name="3.41.39"></a><h3>Fabrication part comparison</h3></p>
...
<p><a name="3.41.40"></a><h3>Fabrication Part ancillary usage additions</h3></p>
...
<p><a name="3.41.41"></a><h3>Fabrication Part custom data additions</h3></p>
...
<p><a name="3.41.42"></a><h3>FabricationConfiguration additions</h3></p>
...
<p><a name="3.41.43"></a><h3>Routing exclusions additions</h3></p>
...
<p><a name="3.41.44"></a><h3>FabricationServiceButton addition</h3></p>
...
<h3><a name="4"></a>Python Automatic HTML Heading Numbering Script</h3>

<p>The following Python script 
<a href="http://thebuildingcoder.typepad.com/files/number_html_headings.py">number_html_headings.py</a> automatically
adds HTML hypertext reference <code>A</code> tags to an HTML file sequentially numbering up to ten levels of headings:</p>
...
<p>I used it to generate 
the <a href="#1">table of contents</a> above.</p>

<p>It handles up to ten heading levels <code>H1</code>..<code>H9</code> and assumes the heading tags are all at the beginning of a line.</p>

<p>I implemented it for and tested it on the
<a href="http://thebuildingcoder.typepad.com/files/revit_platform_api_changes_and_additions_2018_03.htm">input file Revit_Platform_API_Changes_and_Additions_2018_03.htm</a>, generating the 
<a href="http://thebuildingcoder.typepad.com/files/revit_platform_api_changes_and_additions_2018_04.htm">output file Revit_Platform_API_Changes_and_Additions_2018_04.htm</a>.</p>

<p>It will gladden me if you can make use of this as well.</p>
