---
layout: "post"
title: "What's New in the Revit 2019 API"
date: "2018-04-25 05:00:00"
...
categories:
  ...
  - "SDK Samples"
  - "Update"
original_url: "https://thebuildingcoder.typepad.com/blog/2018/04/whats-new-in-the-revit-2019-api.html "
typepad_basename: "whats-new-in-the-revit-2019-api"
...
<p>The Revit 2019 API includes numerous exciting enhancements for add-in developers. Many relate directly to explicit developer wishes and requests:</p>
...
<li><a href="#4">What's new in the Revit 2019 API &ndash; detailed ToC</a> </li>
<li><a href="#4.1">1. API Changes</a> 
<ul>
<li><a href="#4.1.1">1.1. .NET 4.7</a> </li>
<li><a href="#4.1.2">1.2.  View Filters support OR operators and nesting</a> </li>
<li><a href="#4.1.3">1.3. View.ViewName deprecated</a> </li>
<li><a href="#4.1.4">1.4. UI API changes</a> </li>
<li><a href="#4.1.5">1.5. Existing APIs now support open from cloud paths and C4R</a> </li>
<li><a href="#4.1.6">1.6. BasicFileInfo changes</a> </li>
<li><a href="#4.1.7">1.7. Asset-related API members deprecated</a> </li>
<li><a href="#4.1.8">1.8. Double Pattern Support</a> </li>
<li><a href="#4.1.9">1.9. Document.Title consistency</a> </li>
<li><a href="#4.1.10">1.10. View printing &amp; exporting &ndash; activation events change</a> </li>
<li><a href="#4.1.11">1.11. Structural API change</a> </li>
<li><a href="#4.1.12">1.12. Rebar API changes</a> </li>
<li><a href="#4.1.13">1.13. MEP API changes</a> </li>
<li><a href="#4.1.14">1.14. ProjectLocation changes</a> </li>
<li><a href="#4.1.15">1.15. Building Site export removed</a> </li>
<li><a href="#4.1.16">1.16. Obsolete API removal</a> </li>
</ul></li>
<li><a href="#4.2">2. API Additions</a> 
<ul>
<li><a href="#4.2.1">2.1. Material API additions</a> </li>
<li><a href="#4.2.2">2.2. Railing API additions</a> </li>
<li><a href="#4.2.3">2.3. Find Element Dependencies</a> </li>
<li><a href="#4.2.4">2.4. Dimension API additions</a> </li>
<li><a href="#4.2.5">2.5. Set vertical alignment for text</a> </li>
<li><a href="#4.2.6">2.6. BrowserOrganization API additions</a> </li>
<li><a href="#4.2.7">2.7. Rebar API additions</a> </li>
<li><a href="#4.2.8">2.8. Steel Fabrication API additions</a> </li>
<li><a href="#4.2.9">2.9. MEP API additions</a> </li>
<li><a href="#4.2.10">2.10. MEP Fabrication API additions</a> </li>
<li><a href="#4.2.11">2.11. Analysis Visualization Framework API addition</a> </li>
<li><a href="#4.2.12">2.12. IFC additions</a> </li>
<li><a href="#4.2.13">2.13. Revit Link Additions</a> </li>
<li><a href="#4.2.14">2.14. Export Additions</a> </li>
<li><a href="#4.2.15">2.15. Access to add-in data paths</a> </li>
<li><a href="#4.2.16">2.16. Site API additions</a> </li>
<li><a href="#4.2.17">2.17. UI API additions</a> </li>
</ul></li>
</ul>
...
the <a href="http://thebuildingcoder.typepad.com/blog/2018/02/devdays-keynote-manager-and-rex-extensions.html#2">DevDays Online Revit API news video recording</a>.</p>
...
the <a href="http://thebuildingcoder.typepad.com/blog/2018/04/compiling-the-revit-2019-sdk-samples.html#3">Revit 2019 SDK</a>
...
<p>It is also provided in the section on <em>What's New</em> in the Revit 2019 API help file <code>RevitAPI.chm</code> included with the SDK:</p>

<p><center></p>

<p><a class="asset-img-link"  href="http://thebuildingcoder.typepad.com/.a/6a00e553e1689788330224e0349736200d-popup" onclick="window.open( this.href, '_blank', 'width=640,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0' ); return false"><img class="asset  asset-image at-xid-6a00e553e1689788330224e0349736200d image-full img-responsive" alt="Revit 2019 API help on What's New" title="Revit 2019 API help on What's New" src="/assets/image_3b792e.jpg" border="0" style="display: block; margin-left: auto; margin-right: auto;" /></a><br /></p>

<p></center></p>

<p>For convenient, easy and effective web searching, this blog post provides an online version of that information, both in pure HTML (below) as as a PDF document:</p>

<ul>
<li><a href="http://thebuildingcoder.typepad.com/files/revit_platform_api_changes_and_additions_2019.pdf">Revit_Platform_API_Changes_and_Additions_2019.pdf</a></li>
</ul>
...
<p>Here are the steps I performed so far setting up the Revit 2019 SDK and samples:</p>

<ul>
<li>The <a href="http://thebuildingcoder.typepad.com/blog/2018/04/compiling-the-revit-2019-sdk-samples.html">Revit 2019 SDK samples</a></li>
<li><a href="http://thebuildingcoder.typepad.com/blog/2018/04/revitlookup-2019-and-new-sdk-samples.html">RevitLookup</a></li>
<li><a href="http://thebuildingcoder.typepad.com/blog/2018/04/forge-rvt-to-ifc-adn-xtra-tbc-and-adnrme-updates.html#2">The Building Coder samples</a></li>
<li>The <a href="http://thebuildingcoder.typepad.com/blog/2018/04/forge-rvt-to-ifc-adn-xtra-tbc-and-adnrme-updates.html#3">AdnRme MEP HVAC and electrical samples</a></li>
<li>The <a href="http://thebuildingcoder.typepad.com/blog/2018/04/forge-rvt-to-ifc-adn-xtra-tbc-and-adnrme-updates.html#4">AdnRevitApiLabsXtra training labs</a></li>
<li>The <a href="http://thebuildingcoder.typepad.com/blog/2018/04/rvtsamples-2019.html">RvtSamples add-in</a></li>
</ul>
...
<h4><a name="4"></a>What's New in the Revit 2019 API &ndash; Detailed ToC</h4>
...
<h4><a name="4.1.1"></a>1.1. .NET 4.7</h4>

<p>Revit's API assemblies are built using .NET 4.7. At a minimum, add-ons will need to target .NET 4.7 for Revit 2019.</p>

<h4><a name="4.1.2"></a>1.2.  View Filters support OR operators and nesting</h4>

<h4><a name="4.1.2.1"></a>1.2.1. ParameterFilterElement API changes</h4>
...
<li>ParameterFilterElement.GetRuleParameter(FilterRule) &rarr; FilterRule.GetRuleParameter() &ndash; </li>
<li>ParameterFilterElement.GetRuleParameters() &rarr; ParameterFilterElement.GetElementFilterParameters() &ndash;</li>
</ul>
...
<h4><a name="4.1.2.2"></a>1.2.2. ElementLogicalFilter API addition</h4>
...
<h4><a name="4.1.3"></a>1.3. View.ViewName deprecated</h4>
...
<h4><a name="4.1.4"></a>1.4. UI API changes</h4>

<h4><a name="4.1.4.1"></a>1.4.1. Main window handle access</h4>
...
<h4><a name="4.1.4.2"></a>1.4.2. Changes to PostableCommand enumeration</h4>
...
<h4><a name="4.1.5"></a>1.5. Existing APIs now support open from cloud paths (Collaboration for Revit)</h4>

<h4><a name="4.1.5.1"></a>1.5.1. Document Open APIs support cloud paths</h4>
...
<h4><a name="4.1.5.2"></a>1.5.2. Callback for conflict cases when opening from a cloud path</h4>
...
<h4><a name="4.1.6"></a>1.6. BasicFileInfo changes</h4>
...
<h4><a name="4.1.7"></a>1.7. Asset-related API members deprecated</h4>
...
<h4><a name="4.1.8"></a>1.8. Double Pattern Support</h4>

<h4><a name="4.1.8.1"></a>1.8.1. Material API support for double patterns</h4>
...
<li>Material.SurfacePatternColor &rarr; Material.SurfaceForegroundPatternColor, Material.SurfaceBackgroundPatternColor</li>
<li>Material.SurfacePatternId  &rarr; Material.SurfaceForegroundPatternId, Material.SurfaceBackgroundPatternId</li>
<li>Material.CutPatternColor  &rarr; Material.CutForegroundPatternColor, Material.CutBackgroundPatternColor</li>
<li>Material.CutPatternId  &rarr; Material.CutForegroundPatternId, Material.CutBackgroundPatternId</li>
</ul>

<h4><a name="4.1.8.2"></a>1.8.2. Support for overriding double patterns</h4>
...
<h4><a name="4.1.8.3"></a>1.8.3. Support for double patterns for FilledRegion</h4>
...
<h4><a name="4.1.9"></a>1.9. Document.Title consistency</h4>
...
<p>honoured the Windows user setting requiring display of file extensions. The property has been changed to consistently return a title with no extension.</p>

<h4><a name="4.1.10"></a>1.10. View printing &amp; exporting &ndash; activation events behavioral change</h4>
...
<h4><a name="4.1.11"></a>1.11. Structural API change</h4>
...
<h4><a name="4.1.12"></a>1.12. Rebar API changes</h4>
...
<h4><a name="4.1.13"></a>1.13. MEP API changes</h4>
...
<h4><a name="4.1.14"></a>1.14. ProjectLocation changes</h4>
...
<h4><a name="4.1.15"></a>1.15. Building Site export removed</h4>
...
<h4><a name="4.1.16"></a>1.16. Obsolete API removal</h4>
...
<h4><a name="4.1.16.1"></a>Classes</h4>

<h4><a name="4.1.16.2"></a>Methods</h4>
...
<h4><a name="4.1.16.3"></a>Properties</h4>
...
<h4><a name="4.2.1"></a>2.1. Material API additions</h4>

<h4><a name="4.2.1.1"></a>2.1.1. Editing the properties of an Appearance Asset</h4>

<p>New Revit API capabilities have been introduced to edit the properties contained in an appearance asset of a material. These properties appear in the Appearance tab of the Materials dialog and govern the appearance of the material in realistic views and rendering.
Editing the properties in an appearance Asset requires establishment of an edit scope. The new class</p>
...
<h4><a name="4.2.1.2"></a>2.1.2. Editing AssetProperty values</h4>
...
<h4><a name="4.2.1.3"></a>2.1.3. Connected Assets</h4>
...
<h4><a name="4.2.1.4"></a>2.1.4. Validation</h4>

<p>Inputs to change the value of asset properties are validated against the requirements of the associated schema. 
The new methods:</p>
...
<p>identifies the AssetProperty can currently be edited.</p>

<h4><a name="4.2.1.5"></a>2.1.5. Schemas &amp; Property names</h4>
...
<h4><a name="4.2.1.6"></a>2.1.6. Utilities</h4>
...
<h4><a name="4.2.2"></a>2.2. Railing API additions</h4>

<h4><a name="4.2.2.1"></a>2.2.1. Non-Continuous Rail Structure</h4>
...
<h4><a name="4.2.2.2"></a>2.2.2. Baluster Placement</h4>
...
<h4><a name="4.2.3"></a>2.3. Find Element Dependencies</h4>
...
<h4><a name="4.2.4"></a>2.4. Dimension API additions</h4>
...
<h4><a name="4.2.5"></a>2.5. Set vertical alignment for text</h4>
...
<h4><a name="4.2.6"></a>2.6. BrowserOrganization API additions</h4>
...
<h4><a name="4.2.7"></a>2.7. Rebar API additions</h4>

<h4><a name="4.2.7.1"></a>2.7.1. BarTypeDiameterOptions</h4>
...
<h4><a name="4.2.7.2"></a>2.7.2. GetDistributionPath()</h4>

<p>The new method:</p>

<ul>
<li>Autodesk.Revit.DB.Structure.RebarHandlePositionData.GetDistributionPath()
gets the distribution path currently stored in the rebar.
For a free form rebar set the distance between two consecutive bars may be different if it is calculated between different points on bars. The distribution path is an array of curves with the property that based on these curves the set was calculated to respect the layout rule and number of bars or spacing.</li>
</ul>

<h4><a name="4.2.7.3"></a>2.7.3. RebarUpdateCurvesData</h4>
...
<h4><a name="4.2.7.4"></a>2.7.4. RebarShapes</h4>
...
<h4><a name="4.2.7.5"></a>2.7.5. Workshop Instructions</h4>
...
<h4><a name="4.2.7.6"></a>2.7.6. RebarFreeFormAccessor Additions</h4>
...
<h4><a name="4.2.8"></a>2.8. Steel Fabrication API additions</h4>

<h4><a name="4.2.8.1"></a>2.8.1. SteelElementProperties &ndash; linking between Revit elements and steel fabrication elements</h4>
...
<li>Specific steel connection elements (bolts, anchors, plates, etc). These connection elements will be of type Element but with categories related to structural connections, for example:
<ul>
...
<p>This may return a reference to an element or a subelement.</p>

<h4><a name="4.2.8.2"></a>2.8.2. Custom steel connections &ndash; API additions</h4>
...
<h4><a name="4.2.9"></a>2.9. MEP API additions</h4>

<h4><a name="4.2.9.1"></a>2.9.1. MEPCurveType Shape</h4>
...
<h4><a name="4.2.9.2"></a>2.9.2. Mechanical Equipment Set API</h4>

<p>Two new classes allow creation and manipulation of a mechanical equipment set, which is a set of interrelated mechanical equipment in an MEP system that may operate in parallel. This release is limited to supporting one or more pump sets that are part of a piping system. The mechanical equipment set settings will be used for the MEP flow and pressure drop calculations.</p>

<p>The Element subclass Autodesk.Revit.DB.Mechanical.MechanicalEquipmentSet represents an instance of a set associated to an MEP system.</p>

<p>It includes the new members:</p>
...
<h4><a name="4.2.9.3"></a>2.9.3. Hydraulic Separation API</h4>
...
<h4><a name="4.2.10"></a>2.10. MEP Fabrication API additions</h4>

<h4><a name="4.2.10.1"></a>2.10.1. Exporting fabrication job files</h4>
...
<h4><a name="4.2.10.2"></a>2.10.2. API for load and unload of one-off fabrication parts from loose item files</h4>
...
<h4><a name="4.2.10.3"></a>2.10.3. API for version history of parts</h4>
...
<h4><a name="4.2.10.4"></a>2.10.4. API for part swap out information</h4>
...
<h4><a name="4.2.10.5"></a>2.10.5. Centerline length API</h4>
...
<h4><a name="4.2.11"></a>2.11. Analysis Visualization Framework API addition</h4>
...
<p>allows for the use of transparency in the display of the colored surface.</p>

<h4><a name="4.2.12"></a>2.12. IFC additions</h4>
...
<h4><a name="4.2.13"></a>2.13. Revit Link Additions</h4>
...
<h4><a name="4.2.14"></a>2.14. Export Additions</h4>
...
<h4><a name="4.2.15"></a>2.15. Access to add-in data paths</h4>
...
<h4><a name="4.2.16"></a>2.16. Site API additions</h4>
...
<h4><a name="4.2.17"></a>2.17. UI API additions</h4>

<h4><a name="4.2.17.1"></a>2.17.1. BeforeExecutedEventArgs Cancellation</h4>
...
<p>is now permitted to be set to true. This allows the call-back to cancel the execution of the impending command. This can be useful if an add-in wishes to selectively allow the command to proceed based on interactions which take place in this call-back. The property should also report the cancellation status if it has been cancelled by a different subscriber.</p>
