...
date: "2011-02-18 05:00:00"
author: "Jeremy Tammik"
categories:
  - "Installation"
  - "Ribbon"
  - "User Interface"
original_url: "https://thebuildingcoder.typepad.com/blog/2011/02/enable-ribbon-items-in-zero-document-state.html "
typepad_basename: "enable-ribbon-items-in-zero-document-state"
...
<a style="display: inline;" href="http://thebuildingcoder.typepad.com/.a/6a00e553e1689788330147e2a1a92f970b-popup" onclick="window.open( this.href, '_blank', 'width=640,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0' ); return false"><img class="asset  asset-image at-xid-6a00e553e1689788330147e2a1a92f970b image-full" alt="Zero document state" title="Zero document state" src="/assets/image_2ca794.jpg" border="0" /></a> <br />
...
<a style="display: inline;" href="http://thebuildingcoder.typepad.com/.a/6a00e553e1689788330147e2a1a88a970b-popup" onclick="window.open( this.href, '_blank', 'width=640,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0' ); return false"><img class="asset  asset-image at-xid-6a00e553e1689788330147e2a1a88a970b image-full" alt="Zero document state external tools" title="Zero document state external tools" src="/assets/image_491614.jpg" border="0" /></a> <br />
...
<a style="display: inline;" href="http://thebuildingcoder.typepad.com/.a/6a00e553e168978833014e5f468dac970c-popup" onclick="window.open( this.href, '_blank', 'width=640,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0' ); return false"><img class="asset  asset-image at-xid-6a00e553e168978833014e5f468dac970c image-full" alt="Zero document state ribbon panel enabled" title="Zero document state ribbon panel enabled" src="/assets/image_7308d0.jpg" border="0" /></a> <br />

</center>

<p>Here is 

<span class="asset  asset-generic at-xid-6a00e553e1689788330147e2a1a751970b"><a href="http://thebuildingcoder.typepad.com/files/zerodocpanel.zip">ZeroDocPanel.zip</a></span>

containing the entire source code and Visual Studio solution implementing this add-in.
