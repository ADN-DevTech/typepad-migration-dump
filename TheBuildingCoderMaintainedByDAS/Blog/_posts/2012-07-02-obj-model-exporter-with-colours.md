...
categories:
  ...
  - "Geometry"
  - "View"
original_url: "https://thebuildingcoder.typepad.com/blog/2012/07/obj-model-exporter-with-colours.html "
typepad_basename: "obj-model-exporter-with-colours"
...
<a class="asset-img-link"  style="display: inline;" href="http://thebuildingcoder.typepad.com/.a/6a00e553e1689788330167681530ce970b-popup" onclick="window.open( this.href, '_blank', 'width=640,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0' ); return false"><img class="asset  asset-image at-xid-6a00e553e1689788330167681530ce970b image-full" alt="Basic sample model in OBJ" title="Basic sample model in OBJ" src="/assets/image_a02d85.jpg" border="0" /></a><br />
...
<a class="asset-img-link"  style="display: inline;" href="http://thebuildingcoder.typepad.com/.a/6a00e553e168978833017742ef1ae2970d-popup" onclick="window.open( this.href, '_blank', 'width=640,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0' ); return false"><img class="asset  asset-image at-xid-6a00e553e168978833017742ef1ae2970d" alt="Basic sample model element counts" title="Basic sample model element counts" src="/assets/image_3b0445.jpg" border="0" /></a><br />
...
<span class="asset  asset-generic at-xid-6a00e553e16897883301676815333c970b"><a href="http://thebuildingcoder.typepad.com/files/objexport-1.zip">ObjExport.zip</a></span>

including the entire source code, Visual Studio solution and add-in manifest for the OBJ exporter in its current state.
