...
categories:
  ...
  - "SDK Samples"
  - "Units"
original_url: "https://thebuildingcoder.typepad.com/blog/2010/08/slope-is-slope-not-radians.html "
typepad_basename: "slope-is-slope-not-radians"
typepad_status: "Publish"
---

<p>I am still in Thailand, flying home tonight.
...
<center>
atan (0.5) &asymp; 26.57&deg;
</center>

<p>Thanks to Saikat and Scott for raising and clarifying this issue!

<p>In other words, and from another case, if you set a parameter of type slope to a value of 1, the value returned by AsValueString will be 45 degrees (and not 57.217 = 180 / &pi;, for instance).
