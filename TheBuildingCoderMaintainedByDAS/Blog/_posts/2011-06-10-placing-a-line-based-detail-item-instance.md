...
categories:
  ...
  - "Family"
  - "RST"
original_url: "https://thebuildingcoder.typepad.com/blog/2011/06/placing-a-line-based-detail-item-instance.html "
typepad_basename: "placing-a-line-based-detail-item-instance"
typepad_status: "Publish"
---

<p>We already talked in depth about 

<a href="http://thebuildingcoder.typepad.com/blog/2010/10/place-detail-
...
<a href="http://thebuildingcoder.typepad.com/blog/2011/01/newfamilyinstance-
...
<p>Here is an interesting update to the issue by Frode Tørresdal of 
...
<p><strong>Question:</strong> I am trying to place a detail item over an existing 
...
&nbsp; <span class="teal">FamilySymbol</span> symbol = <span 

class="blue">null</span>;
&nbsp;
...
<p>What I'm trying to do is to make a function where the user selects a 3D 
...
<p>I can do this manually in Revit by placing my detail item along one side of the 3D 

element to set the width, and then adjusting a parameter in the detail item to set 

the height. 

<p>Using the API, I can adjust the parameter to get the right height, but I cannot 
...
<ul>
<li>Place a line based detail element at the min value of the bounding box of a 

selected 3D element in plan view.
<li>Extend the line based element so that the length is equal to one of the sides of 

the bounding box of the selected 3D element in a plan view.
</ul>

<p>I hope this makes sense. I'm rather new to the Revit API and might be missing 

something obvious.

<p><strong>Solution:</strong> While creating a test case I think I solved the 

problem.

<p>I found a new overload of the NewFamilyInstance method in Revit 2012 that takes 
...
<p>That leads me to look in more detail at the new overloads of the NewFamilyInstance 
...
<p>The nine overloads of the NewFamilyInstance method provided by the Revit 2011 API 
...
<ul>
<li>Adding a line based detail family instance into the Revit document, using a line 

and a view where the instance should be placed.
<li>Inserting a new instance of a family onto a face referenced by the input 
...
<p>As the issues arising in this area indicate, the topic of adding a new family 
