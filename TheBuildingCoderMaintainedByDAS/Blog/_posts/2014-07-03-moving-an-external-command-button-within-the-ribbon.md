---
layout: "post"
title: "Moving an External Command Button within the Ribbon"
date: "2014-07-03 05:00:00"
...
categories:
  ...
  - "Ribbon"
  - "User Interface"
original_url: "https://thebuildingcoder.typepad.com/blog/2014/07/moving-an-external-command-button-within-the-ribbon.html "
typepad_basename: "moving-an-external-command-button-within-the-ribbon"
...
<a class="asset-img-link"  style="display: inline;" href="http://thebuildingcoder.typepad.com/.a/6a00e553e16897883301a3fd29ec2e970b-popup" onclick="window.open( this.href, '_blank', 'width=640,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0' ); return false"><img class="asset  asset-image at-xid-6a00e553e16897883301a3fd29ec2e970b image-full img-responsive" alt="Moving an external command ribbon button" title="Moving an external command ribbon button" src="/assets/image_f30f5c.jpg" border="0" /></a><br />
</center>
