---
layout: "post"
title: "Need for Regen and Duplicate Parameter Access"
...
categories:
  ...
  - "Python"
  - "Regen"
original_url: "https://thebuildingcoder.typepad.com/blog/2016/12/need-for-regen-and-parameter-display-name-confusion.html "
typepad_basename: "need-for-regen-and-parameter-display-name-confusion"
...
<ul>
<li><p>Transaction #1: Add a suffix ("-x") to each detail number to ensure the new numbers won’t conflict (1 will be 1-x, 4 will be 4-x, etc.)</p></li>
<li><p>Transaction #2: Change detail numbers with calculated new number based on viewport location (1-x will be 3, 4-x will be 2, etc.)</p></li>
</ul>
...
<p>Here 
is <a href="http://thebuildingcoder.typepad.com/files/rename_view_numbers.pdf">rename_view_numbers.pdf showing a visual explanation</a> 
(<a href="https://www.docdroid.net/EP1K9Di/161115-viewport-diagram-.pdf.html">^</a>) and
the 
<a href="http://thebuildingcoder.typepad.com/files/rename_view_numbers.py">complete Python file rename_view_numbers.py</a> 
(<a href="http://pastebin.com/7PyWA0gV">^</a>).</p>

<p><center></p>

<p><a class="asset-img-link"  style="display: inline;" href="http://thebuildingcoder.typepad.com/.a/6a00e553e16897883301bb095d250a970d-popup" onclick="window.open( this.href, '_blank', 'width=640,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0' ); return false"><img class="asset  asset-image at-xid-6a00e553e16897883301bb095d250a970d img-responsive" style="width: 476px; " alt="Set parameter throws read-only error" title="Set parameter throws read-only error" src="/assets/image_8fa25e.jpg" /></a><br /></p>
...
<p><a class="asset-img-link"  style="display: inline;" href="http://thebuildingcoder.typepad.com/.a/6a00e553e16897883301b8d243e3be970c-popup" onclick="window.open( this.href, '_blank', 'width=640,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0' ); return false"><img class="asset  asset-image at-xid-6a00e553e16897883301b8d243e3be970c img-responsive" style="width: 304px; " alt="Duplicate parameter display names" title="Duplicate parameter display names" src="/assets/image_98bc0a.jpg" /></a><br /></p>
...
cf. <a href="http://thebuildingcoder.typepad.com/files/rename_view_number_duplicates.pdf">rename_view_number_duplicates.pdf</a> 
