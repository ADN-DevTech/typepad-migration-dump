...
categories:
  ...
  - "User Interface"
  - "Utilities"
original_url: "https://thebuildingcoder.typepad.com/blog/2009/11/model-review.html "
typepad_basename: "model-review"
typepad_status: "Publish"
---

<p>We recently mentioned the 
...
<a style="display: inline;" href="http://thebuildingcoder.typepad.com/.a/6a00e553e1689788330120a64f1a07970b-popup" onclick="window.open( this.href, '_blank', 'width=640,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0' ); return false"><img class="asset  asset-image at-xid-6a00e553e1689788330120a64f1a07970b image-full" alt="Autodesk Revit Model Review" title="Autodesk Revit Model Review" src="/assets/image_94bb5f.jpg" border="0"  /></a> <br />

</center>

<h4>The Checking Platform</h4>

<p>Model Review is not just a configurable set of checks provided by Autodesk &ndash; it is also a platform for developers to write their own checks and plug them in to the checking process. 
...
<p>Developers implement a few methods defining how the check should be configured, executed, reported &ndash; and optionally corrected. 
...
<span class="asset  asset-generic at-xid-6a00e553e1689788330120a64f18d0970b"><a href="http://thebuildingcoder.typepad.com/files/developing_modelreview_plugins.pdf">plug-in developer guide</a></span>.
