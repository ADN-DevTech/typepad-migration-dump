---
layout: "post"
title: "Retrieving Wall Openings and Sorting Points"
...
categories:
  ...
  - "Performance"
  - "SDK Samples"
original_url: "https://thebuildingcoder.typepad.com/blog/2015/12/retrieving-wall-openings-and-sorting-points.html "
typepad_basename: "retrieving-wall-openings-and-sorting-points"
...
<p><a class="asset-img-link"  style="display: inline;" href="http://thebuildingcoder.typepad.com/.a/6a00e553e16897883301b7c7fb873d970b-popup" onclick="window.open( this.href, '_blank', 'width=640,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0' ); return false"><img class="asset  asset-image at-xid-6a00e553e16897883301b7c7fb873d970b img-responsive" style="width: 412px; " alt="Wall opening points" title="Wall opening points" src="/assets/image_54f475.jpg" /></a><br /></p>

<p></center></p>

<p>I've tried FindInserts(), but it's not given that anything is inserted in the opening (cf. the <a href="#3.1">addendum below</a>).</p>
...
<p><a class="asset-img-link"  style="display: inline;" href="http://thebuildingcoder.typepad.com/.a/6a00e553e16897883301bb08a000dc970d-popup" onclick="window.open( this.href, '_blank', 'width=640,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0' ); return false"><img class="asset  asset-image at-xid-6a00e553e16897883301bb08a000dc970d img-responsive" style="width: 407px; " alt="Wall openings at wall ends" title="Wall openings at wall ends" src="/assets/image_b8b854.jpg" /></a><br /></p>
...
<p><a class="asset-img-link"  style="display: inline;" href="http://thebuildingcoder.typepad.com/.a/6a00e553e16897883301b8d1854d7f970c-popup" onclick="window.open( this.href, '_blank', 'width=640,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0' ); return false"><img class="asset  asset-image at-xid-6a00e553e16897883301b8d1854d7f970c img-responsive" style="width: 327px; " alt="Intersection points returned by ReferenceIntersector.Find" title="Intersection points returned by ReferenceIntersector.Find" src="/assets/image_1cab70.jpg" /></a><br /></p>
...
<ol>
<li><p>I just use the currently active user selected 3D view.</p></li>
<li><p>Yes, I noticed and added that as well.</p></li>
<li><p>Nope. The points I list above are the exact results of the call to Find, with nothing added or removed. I think my problems were caused by using elevation zero, so the ray was passing through the bottom edges of the wall faces. That way, it is hit or miss whether an intersection is found or not. I raised it off the floor and extend it beyond the wall at each end by 0.1 feet, and then I get reliable results. I am surprised that is not causing problems for you.</p></li>
<li><p>My code works well too. Check it out on GitHub. If you see any further possible improvements, please let me know.</p></li>
</ol>
...
<p>I cleaned it up a bit more, and the version presented below is
<a href="https://github.com/jeremytammik/the_building_coder_samples/releases/tag/2016.0.125.1">release 2016.0.125.1</a>.</p>

<p>I performed minimal testing of it on these three different walls:</p>

<p><center></p>

<p><a class="asset-img-link"  style="display: inline;" href="http://thebuildingcoder.typepad.com/.a/6a00e553e16897883301b8d1854d8c970c-popup" onclick="window.open( this.href, '_blank', 'width=640,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0' ); return false"><img class="asset  asset-image at-xid-6a00e553e16897883301b8d1854d8c970c img-responsive" style="width: 430px; " alt="Three walls with openings" title="Three walls with openings" src="/assets/image_33416e.jpg" /></a><br /></p>
...
<p><a class="asset-img-link"  style="display: inline;" href="http://thebuildingcoder.typepad.com/.a/6a00e553e16897883301b7c7fb8798970b-popup" onclick="window.open( this.href, '_blank', 'width=640,height=480,scrollbars=no,resizable=no,toolbar=no,directories=no,location=no,menubar=no,status=no,left=0,top=0' ); return false"><img class="asset  asset-image at-xid-6a00e553e16897883301b7c7fb8798970b img-responsive" style="width: 366px; " alt="Wall opening coordinates" title="Wall opening coordinates" src="/assets/image_6cc0ee.jpg" /></a><br /></p>
...
<h4><a name="3.1"></a>Addendum</h4>

<p>Eirik's statement in the initial query implies that <code>FindInserts</code> does not return wall openings that do not host any insert, w.g., a door or window family instance.</p>

<p>This is not true, as Scott Wilson later pointed out. Scott also provided an alternative implementation determining and
displaying <a href="http://thebuildingcoder.typepad.com/blog/2015/12/wall-opening-profiles-and-happy-holidays.html">wall opening profiles using FindInserts</a>, which you might want to have a look at as well.</p>
