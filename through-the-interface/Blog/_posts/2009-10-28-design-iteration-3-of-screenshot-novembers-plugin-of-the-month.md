---
layout: "post"
title: "Design iteration #3 of Screenshot, November&rsquo;s Plugin of the Month"
date: "2009-10-28 23:26:21"
...
categories:
  ...
  - "Plugin of the Month"
  - "Selection"
original_url: "https://www.keanw.com/2009/10/design-iteration-3-of-screenshot-novembers-plugin-of-the-month.html "
typepad_basename: "design-iteration-3-of-screenshot-novembers-plugin-of-the-month"
typepad_status: "Publish"
---

<p>Now that I’m completely finished with <a href="http://through-the-interface.typepad.com/through_the_interface/2009/10/au-2009-attend-one-of-my-sessions-from-the-comfort-of-your-armchair.html">my AU 2009 preparation</a>, it’s time for me to get back to the next “<a href="http://labs.autodesk.com/utilities/ADN_plugins">Plugin of the Month</a>”, given that we have just a few days left of the month of October.</p>
<p>Here’s another iteration of the application, this time implementing the following enhancements:</p>
<ul>
<li>The application now keeps the chosen settings: they follow you between drawings and even between sessions. 
<li>We now perform a Regen after selecting objects to capture to unhighlight them 
<li>There is now a “Print” setting, which gives the option of sending the capture image directly to a printer 
<ul>
<li>The image should be scaled to fit the page, all being well 
<li>I’m not 100% sure I have the algorithm right for the image scaling: feedback is welcome, as ever </li>
</li></ul>
<li>The default location to which captured images are saved if the location of the current drawing 
<li>There’s a slightly longer delay after selecting the file location, to make sure we don’t get dialog artifacts in the capture 
<li>The application should hopefully now support 64-bit versions of AutoCAD (although I’m yet to test this myself) </li>
</li></li></li></li></li></ul>
<p>A huge “thank you” to Bill Woodhams for suggesting most of these changes and testing the results.</p>
...
<p style="MARGIN: 0px; FONT-SIZE: 8pt"><span style="LINE-HEIGHT: 140%; COLOR: blue">using</span><span style="LINE-HEIGHT: 140%"> System.Windows.Interop;</span></p>
...
<p style="MARGIN: 0px; FONT-SIZE: 8pt">&#0160;</p>
<p style="MARGIN: 0px; FONT-SIZE: 8pt"><span style="LINE-HEIGHT: 140%; COLOR: green">//using DemandLoading;</span></p>
<p style="MARGIN: 0px; FONT-SIZE: 8pt">&#0160;</p>
...
<p style="MARGIN: 0px; FONT-SIZE: 8pt"><span style="LINE-HEIGHT: 140%">&#0160; &#0160; &#0160; {</span></p>
<p style="MARGIN: 0px; FONT-SIZE: 8pt"><span style="LINE-HEIGHT: 140%">&#0160; &#0160; &#0160; &#0160; </span><span style="LINE-HEIGHT: 140%; COLOR: green">// RegistryUpdate.RegisterForDemandLoading();</span></p>
<p style="MARGIN: 0px; FONT-SIZE: 8pt"><span style="LINE-HEIGHT: 140%">&#0160; &#0160; &#0160; }</span></p>
...
<p style="MARGIN: 0px; FONT-SIZE: 8pt"><span style="LINE-HEIGHT: 140%">&#0160; &#0160; {</span></p>
<p style="MARGIN: 0px; FONT-SIZE: 8pt"><span style="LINE-HEIGHT: 140%">&#0160; &#0160; &#0160; </span><span style="LINE-HEIGHT: 140%; COLOR: green">// RegistryUpdate.UnregisterForDemandLoading();</span></p>
<p style="MARGIN: 0px; FONT-SIZE: 8pt"><span style="LINE-HEIGHT: 140%">&#0160; &#0160; }</span></p>
<p style="MARGIN: 0px; FONT-SIZE: 8pt">&#0160;</p>
...
<p style="MARGIN: 0px; FONT-SIZE: 8pt"><span style="LINE-HEIGHT: 140%">&#0160; &#0160; &#0160; &#0160; </span><span style="LINE-HEIGHT: 140%; COLOR: #a31515">&quot;Background={1}, Foreground={2}, Grayscale={3}&quot;</span><span style="LINE-HEIGHT: 140%">,</span></p>
...
<p style="MARGIN: 0px; FONT-SIZE: 8pt"><span style="LINE-HEIGHT: 140%">&#0160; &#0160; &#0160; &#0160; </span><span style="LINE-HEIGHT: 140%; COLOR: green">// (300 msec = 3/10ths of a second - may need tweaking)</span></p>
<p style="MARGIN: 0px; FONT-SIZE: 8pt">&#0160;</p>
<p style="MARGIN: 0px; FONT-SIZE: 8pt"><span style="LINE-HEIGHT: 140%">&#0160; &#0160; &#0160; &#0160; System.Threading.</span><span style="LINE-HEIGHT: 140%; COLOR: #2b91af">Thread</span><span style="LINE-HEIGHT: 140%">.Sleep(300);</span></p>
<p style="MARGIN: 0px; FONT-SIZE: 8pt"><span style="LINE-HEIGHT: 140%">&#0160; &#0160; &#0160; }</span></p>
<p style="MARGIN: 0px; FONT-SIZE: 8pt">&#0160;</p>
...
<p>Now if you use the “Print” setting (by changing it to “Yes”) whenever a capture is taken you will be shown a simple print dialog:</p>
<p><a href="http://through-the-interface.typepad.com/.a/6a00d83452464869e20120a68638cb970c-pi"><img alt="Print dialog" border="0" height="281" src="/assets/image_329774.jpg" style="BORDER-RIGHT-WIDTH: 0px; DISPLAY: inline; BORDER-TOP-WIDTH: 0px; BORDER-BOTTOM-WIDTH: 0px; BORDER-LEFT-WIDTH: 0px" title="Print dialog" width="371" /></a> </p>
<p>This should happen irrespective of whether the image is being saved to a file or copied to the clipboard.</p>
<p>This is almost certainly the final iteration of this tool, so if you have any final feedback, please send it across. And thanks again to all who have contributed, so far, to the design of the tool: I’ve tried to list everyone who has done so in the accompanying ReadMe file to be included in the eventual distribution.</p>
