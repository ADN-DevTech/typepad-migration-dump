---
layout: "post"
title: "AEC Data Model サンプル：ドア数量拾い"
date: "2023-12-13 00:08:32"
author: "Toshiaki Isezaki"
categories:
  - "API カスタマイズ"
  - "クラウドサービス"
original_url: "https://adndevblog.typepad.com/technology_perspective/2023/12/aec-data-model-sample-task-2.html "
typepad_basename: "aec-data-model-sample-task-2"
typepad_status: "Publish"
---

<p><a class="asset-img-link" href="https://adndevblog.typepad.com/.a/6a0167607c2431970b02c8d3a09615200c-pi" style="display: inline;"><img alt="Aec_data_model" border="0" class="asset  asset-image at-xid-6a0167607c2431970b02c8d3a09615200c image-full img-responsive" src="/assets/image_698195.jpg" title="Aec_data_model" /></a></p>
<p><a href="https://adndevblog.typepad.com/technology_perspective/2023/11/aec-data-model-sample-preparation.html" rel="noopener" target="_blank">AEC Data Model サンプル：事前準備</a> の内容に沿って、<a href="https://github.com/autodesk-platform-services/aps-aecdatamodel-samples/tree/main" rel="noopener" target="_blank">GitHub - autodesk-platform-services/aps-aecdatamodel-samples</a> リポジトリを Windows ローカル環境にクローン・セットアップ済で実行出来ることを前提に、<a href="https://github.com/autodesk-platform-services/aps-aecdatamodel-samples/blob/main/QuantityTakeOff.md" rel="noopener" target="_blank">Quantity takeoff for Doors（ドア数量拾い）</a>の内容を処理していきます。</p>
<p>このサンプルでは、「ドア」の数量拾いを実現する目的で、「ドア」カテゴリでフィルタリングされたすべての要素を取得します。</p>
<ul>
...
<p>後述の Step 1 ～ Step 4 の手順を実行するには、<a href="https://adndevblog.typepad.com/technology_perspective/2023/11/aec-data-model-sample-preparation.html" rel="noopener" target="_blank">AEC Data Model サンプル：事前準備</a>&#0160;でご紹介した手順でセットアップしたサンプルを起動して、「<a href="https://github.com/autodesk-platform-services/aps-aecdatamodel-samples/blob/main/DesignValidation.md" rel="noopener" target="_blank">Quantity takeoff for Doors Sample Workflow</a>」の&#0160;<span style="background-color: #0d6efd; color: #ffffff;">[Go to sample]</span>&#0160;をクリックしてください。</p>
<ul>
...
<p>Step 2 で取得した Project ID を「<strong>Step 3: List all designs in a project</strong>」下のテキストボックスに入力後、<span style="background-color: #0d6efd; color: #ffffff;">[List all designs]</span> をクリックして Project 配下にある全デザイン（Revit プロジェクト ファイル）を取得します。表示されたデザインから、数量拾いの対象となる Design ID を書き留めます。（下記の例では「サンプル意匠.rvt」）</p>
<p><a class="asset-img-link" href="https://adndevblog.typepad.com/.a/6a0167607c2431970b02c8d3a578fb200d-pi" style="display: inline;"><img alt="Step_3" border="0" class="asset  asset-image at-xid-6a0167607c2431970b02c8d3a578fb200d image-full img-responsive" src="/assets/image_735305.jpg" title="Step_3" /></a></p>
<p><strong>使用した GraphQL クエリ：</strong></p>
<blockquote>
<div>
...
<p><strong>Step 4：すべてのプロパティを取得する</strong></p>
<p>Step 3 で取得した Design ID を「<strong>Step 4: List all doors in a design</strong>」直下のテキストボックスに入力、また、その下のテキストボックスに数量拾いをドア インスタンスとするよう、「<strong>property.name.category==Doors and &#39;property.name.Element Context&#39;==Instance</strong>」と入力後、<span style="background-color: #0d6efd; color: #ffffff;">[Generate quantity takeoff]</span> をクリックして Design 中にある全てのドア ファミリインスタンスを取得します。</p>
<p><a class="asset-img-link" href="https://adndevblog.typepad.com/.a/6a0167607c2431970b02c8d3a11dad200c-pi" style="display: inline;"><img alt="Step_4" border="0" class="asset  asset-image at-xid-6a0167607c2431970b02c8d3a11dad200c image-full img-responsive" src="/assets/image_66704.jpg" title="Step_4" /></a></p>
<p><strong>使用した GraphQL クエリ：</strong></p>
<div>
<blockquote>
<div>query getQuantityTakeoff ($designId: ID!, $elementsfilter: String!){</div>
