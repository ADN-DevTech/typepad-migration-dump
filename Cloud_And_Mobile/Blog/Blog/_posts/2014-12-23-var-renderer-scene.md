---
layout: "post"
title: "Merry Christmas & Happy New Year 2015!"
date: "2014-12-23 08:19:57"
author: "Philippe Leefsma"
categories: []
original_url: "https://adndevblog.typepad.com/cloud_and_mobile/2014/12/var-renderer-scene.html "
typepad_basename: "var-renderer-scene"
typepad_status: "Publish"
---

<p>By <a href="http://adndevblog.typepad.com/autocad/balaji-ramamoorthy.html">Balaji Ramamoorthy</a></p>
<p><strong>ADN</strong> wishes you a Merry Christmas and Happy New year !<br /><br />Here is a Christmas tree with lots of gifts. <br /><br />Hope you like it :)</p>

<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.2.6/jquery.min.js"></script>
<script type="text/javascript" src="http://cdnjs.cloudflare.com/ajax/libs/three.js/r67/three.js"></script>

<div id='x-mas-container'>

<div id='x-mas-img'>

Click <a href='http://adndevblog.typepad.com/cloud_and_mobile/2014/12/var-renderer-scene.html' target='_blank'> here </a> for the live demo.

<a class="asset-img-link"  style="display: inline;" href="http://adndevblog.typepad.com/.a/6a0167607c2431970b01b7c72ff0bf970b-pi"><img class="asset  asset-image at-xid-6a0167607c2431970b01b7c72ff0bf970b image-full img-responsive" alt="Xmas tree" title="Xmas tree" src="/assets/image_7e1c46.jpg" border="0" /></a>
...
if(window.location.toString().indexOf('var-renderer-scene.html') > 0) {

$('#x-mas-img').remove();

var html = '<div id="xmas-tree" style="border:1px solid blue;width:350px;height:350px;"></div>'

$('#x-mas-container').append(html);

			var Autodesk = Autodesk || {};
			Autodesk.ADN = Autodesk.ADN || {};

			Autodesk.ADN.XMasTree = function () {
				...
				function ChristmasTree() {
					...
					for (var j = 0; j < layers; j++) {
						...
						else { // Top most layer, no rotation
			...
			var xmastree = new Autodesk.ADN.XMasTree();
}

</script>

<p><span class="asset  asset-generic at-xid-6a0167607c2431970b01b8d0afea5e970c img-responsive"><a href="http://adndevblog.typepad.com/files/xmas-tree-3.zip">Download Xmas-tree Source</a></span></p>
