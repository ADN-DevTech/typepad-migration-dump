---
layout: "post"
title: "Setup NodeJs Enviroment on Amazon EC2 linux"
date: "2014-12-10 20:18:07"
author: "Daniel Du"
categories:
  - "Cloud"
  - "Daniel Du"
original_url: "https://adndevblog.typepad.com/cloud_and_mobile/2014/12/setup-nodejs-enviroment-on-amazon-ec2-linux.html "
typepad_basename: "setup-nodejs-enviroment-on-amazon-ec2-linux"
...
<p>NodeJs is very popular in web programming, you can use single language - JavaScript - to create the back end logic and the front end web page. Installing NodeJs environment on Mac or Windows is relatively easy, while if I need to put my Node.Js sample into production, I will have to set it up on Linux. Of cause I can choose Windows to host Node.Js application, but I prefer to choose the free Linux, which is a good practice for me as well.</p>
...
<p>I’d like to start from t2.micro, which is free tier eligible. Once I find it not powerful enough for your application, I can scale up or scale out easily.<br />
...
<p>The source code of git is downloaded to my linux server.</p>
<p><br />
...
<p>I’d like to use Node 0.10.32, so I check it out with following command, you can choose your favourite version. And we install from source code, it may take a few minutes to complete.</p>
...
<p>I need to add it to sudo’s path so that I can install more packages.</p>
...
<p><br />
<img src="/assets/image_a67a03.jpg" width="480" height="179" alt="201412111037.jpg" /></p>
<p>Now I will create a very sample Node.Js application to verify the environment works fine.</p>
...
<p>A few seconds latter, my files are uploaded, let’s back to the terminal of EC2 instance to start the Node.Js application. Before running it.</p>
<p style="margin-top: 0px; margin-bottom: 0px; font-size: 18px; line-height: normal; font-family: 'Andale Mono'; color: #29F914; background-color: #000000;"><br /></p>
...
<p>Now the Node.Js application is running (I am using 80 port) , I can now access it from browser. It is just a samplest express site, but the Node.Js environment looks fine now.</p>
<p><br />
<img src="/assets/image_f82574.jpg" width="480" height="259" alt="201412111202.jpg" /></p>
<p>Next step, I will create a new AMI based on this instance, I do not want to repeat all these steps everything when I need a NodeJs Linux instance :) Go the AWS Console, right click the instance and choose Image -&gt; Create Image:</p>
<p><br />
